...
define('model/data', ["underscore", "backbone", "util/ajax", "lib/shellapp", "util/local-storage", "util/language-message", "lib/mobage-jssdk"], function(a, b, c, d, e, f, g) {
    ...
    var h = [],
        ...
        function e(a) {
            ...
            c.set({id_token: a.id_token}), c.save(null, {success: function(a, b) {
        ...
        function j(a, b) {
            a && e(a, b), b && window.location.reload()
        }
        if (c) {
            var k = c.local_notification;
            d.isShellApp() && !a.isEmpty(k) && d.setLocalNotification(k);
            var l = c.redirect;
            l && a.isString(l) && (Game.view.stopListening(this), 0 === c.redirect.indexOf("#") ? window.location.hash = l.slice(1) : window.location.href = l, c.refresh && window.location.reload());
            var m = c.auth_status, n = window.clientData;
            if ("require_auth" === m)
                if (Game.ua.isMbga()) {
                    if (n && n.state) {
                        var o = a.clone(n.state);
                        h.push(c), g.mobageGetConnectedStatus({state: o}).done(function(b) {
                            var d = b;
                            n.state = c.state, d.response.state = n.state, g.login(n, d, function() {
                                h.shift(), a.isEmpty(h) && window.location.reload()
                            })
                        }).fail(function(a) {
                            window.location.reload()
                        })
                    ...
                    Game.ua.isGreeLogin() ? i || (i = !0, GREE.oauth.getConnectedStatus(j)) : window.location.hash = "#top";
            var p = c.popup;
            if (!a.isEmpty(p))
                return Game.view.trigger("loadEnd"), Game.view.trigger("popup_error", {data: p}), Game.view.stopListening(this), this.off(), {errorPopFlag: !0};
            var q = c.option;
            if (q) {
                var r = q.iframes;
                if (!a.isEmpty(r)) {
...
define('setting', ["jquery", "underscore", "lib/sound", "util/navigate", "model/token-data"], function(a, b, c, d, e) {
    var f = window.Game = window.Game || {}, g = window.CanvasRenderingContext2D;
    if (g) {
        ...
        h && (g.prototype.drawImage = function(a, c, d, e, f, g, i, j, k) {
            if (b.isUndefined(j) && b.isUndefined(k))
                ...
                var m = c + e < a.width ? e : a.width - c, n = d + f < a.height ? f : a.height - d;
                try {
    ...
    var i = function(a, b, c) {
        var d = a.split("/"), e = d.slice(0, 3).join("/"), f = d.slice(3).join("/");
        return e + "/" + f.replace(b, c)
    }, j = function(b) {
        var c = f.setting.dpi_mode = Number(b);
        switch (c) {
            case 0:
                f.cssUri = i(f.cssUri, /css[^\/]*/, "css_low"), f.imgUri = i(f.imgUri, /img[^\/]*/, "img_low"), f.jsUri = i(f.jsUri, /js[^\/]*/, "js_low");
                break;
            case 1:
                f.cssUri = i(f.cssUri, /css[^\/]*/, "css_mid"), f.imgUri = i(f.imgUri, /img[^\/]*/, "img_mid"), f.jsUri = i(f.jsUri, /js[^\/]*/, "js_mid");
                break;
            case 2:
                f.cssUri = i(f.cssUri, /css[^\/]*/, "css"), f.imgUri = i(f.imgUri, /img[^\/]*/, "img"), f.jsUri = i(f.jsUri, /js[^\/]*/, "js");
                break;
            default:
                f.cssUri = i(f.cssUri, /css[^\/]*/, "css_light"), f.imgUri = i(f.imgUri, /img[^\/]*/, "img_light"), f.jsUri = i(f.jsUri, /js[^\/]*/, "js_light"), f.setting.dpi_mode = 0
        }
        return (new a.Deferred).resolve()
    }, k = function(b, d) {
        var e = new a.Deferred, g = f.setting, h = g.sound_flag = Number(b), i = h && (g.bgm_mode || g.se_mode || g.voice_mode);
        return (0 === +g.effect_mode || 0 === +i) && (h = g.sound_flag = 0), h ? a.when(c.setup(d)).then(function() {
            c.enable()
        }).then(function() {
            e.resolve()
        ...
        var e = new a.Deferred, g = f.setting[b.replace(/(\/$)|(\^)/g, "") + "_mode"] = Number(d);
        switch (g) {
            case 0:
        ...
        return (0 == f.setting.effect_mode || !c.isSupportedWebAudio() && !c.isSupportedNativeAudio()) && (a = 0), l("^bgm/", a)
    }, n = function(a) {
        return (0 == f.setting.effect_mode || !c.isSupportedWebAudio() && !c.isSupportedNativeAudio()) && (a = 0), l("^se/", a)
    }, o = function(a) {
        return (0 == f.setting.effect_mode || !c.isSupportedWebAudio() && !c.isSupportedNativeAudio()) && (a = 0), l("^voice/", a)
    }, p = function(a, b) {
        return f.setting[a.replace(/\/$/, "") + "_volume"] = b, c.setLocalVolume(a, b / 100)
    }, q = function(a) {
        p("bgm/", a)
    }, r = function(a) {
        p("se/", a)
        ...
        var c = new (e.extend({urlRoot: f.baseUri + "setting/save"}));
        return c.set(a, {silent: !0}), c.save()
    }, v = function(a) {
        b.extend(f.setting, a);
        var c = new (e.extend({urlRoot: f.baseUri + "tutorial/save_setting"}));
        return c.set(a, {silent: !0}), c.save()
    };
    return {initialize: t,enableSound: k,enableBGM: m,enableSE: n,enableVoice: o,setBGMVolume: q,setSEVolume: r,setVoiceVolume: s,setResolution: j,saveSetting: u,saveTutorialSetting: v}
});
...
define('util/touch', ["jquery", "underscore", "util/function", "flexslider"], function(a, b, c) {
    var d = "ontouchstart" in window, e = "onmousedown" in window, f = d ? "touchstart" : "mousedown", g = d ? "touchmove" : "mousemove", h = d ? "touchend" : "mouseup";
    if (a.event.special.cgtouchstart = {bindType: f,delegateType: f}, a.event.special.cgtouchmove = {bindType: g,delegateType: g}, a.event.special.cgtouchend = {bindType: h,delegateType: h}, Game.ua.isPcPlatformHasTouch = Game.ua.isPcPlatform() && d && e, !d || Game.ua.isPcPlatformHasTouch) {
        var i = a(window), j = Math.max(document.documentElement.clientWidth, window.innerWidth || 0), k = Math.max(document.documentElement.clientHeight, window.innerHeight || 0), l = {mousedown: "touchstart",mousemove: "touchmove",mouseup: "touchend"}, m = {};
        b.each(l, function(a, b) {
            var c = m[a] = document.createEvent("UIEvent");
            c.initUIEvent(a, !0, !0, window, 1), c.touches = c.targetTouches = c.changedTouches = [{}]
        });
        var n = function(b) {
            ...
            var c = a.type;
            if (n(a) && (c = "mouseup"), d && "mouseup" === a.type && "undefined" != typeof TouchEvent && "undefined" != typeof Touch) {
                var e = m.touchstart.target, f = {identifier: 0,target: e};
                b.each(["clientX", "clientY", "pageX", "pageY", "screenX", "screenY"], function(b) {
                    f[b] = a[b]
                });
                var g = new Touch(f);
                h = new TouchEvent("touchend", {changedTouches: [g]}), e.dispatchEvent(h)
            } else {
                var h = m[l[c]];
                b.each(["clientX", "clientY", "pageX", "pageY", "screenX", "screenY"], function(b) {
                ...
                e && (h.touches[0].target = e, h.touches[0].identifier = 0, h.changedTouches = h.touches, e.dispatchEvent(h))
            }
        }, p = function(a) {
            d && "CANVAS" !== a.target.tagName || n(a) || (i.on("mousemove", q), i.on("mouseup", r), o(a))
        }, q = function(a) {
            n(a) ? r(a) : o(a)
        }, r = function(a) {
            i.off("mousemove", q), i.off("mouseup", r), o(a)
        };
        if (i.on("mousedown", p), !d) {
            var s = a.flexslider;
            a.flexslider = function(a, b) {
                window.ontouchstart = c.returnFalse, s.call(this, a, b), delete window.ontouchstart
...
define('view/chat/form', ["jquery", "underscore", "backbone", "view/popup", "util/language-message"], function(a, b, c, d, e) {
    var f = 140, g = "#pop-chat", h = "submit", i = "submissionEmptyError", j = "submissionExcessError", k = c.View.extend({el: "#general-chat .chat-form",events: {"tap #chat-input:not(.disable)": "userFocus","touchstart #chat-send:not(.disable)": "checkMessage"},initialize: function() {
            this.$input = this.$el.find("#chat-input"), this.$send = this.$el.find("#chat-send"), this.setupInput()
        },setupInput: function(a) {
            var b = this;
            a = a || b.$input, a.keyup(function(a) {
                return 13 === a.keyCode ? !1 : void 0
            }), a.keypress(function(a) {
                return 13 === a.keyCode ? !1 : void 0
            })
        },disable: function() {
            this.$send.addClass("disable"), this.$input.addClass("disable"), this.disableInput()
        },disableInput: function() {
            this.$input.attr("disabled", "disabled")
        },enable: function() {
            this.$send.removeClass("disable"), this.$input.removeClass("disable"), this.enableInput()
            ...
            a.stopPropagation(), this.trigger("userfocus")
        },checkMessage: function(a) {
            if (this.blurInput(), this.inputComment = this.$input.val(), !this.inputComment || !this.inputComment.match(/\S/)) {
                this.clearInput();
            ...
            this.trigger(h, {comment: this.inputComment}), this.clearInput(), a && (a.preventDefault(), Game.ua.isJssdk() || a.stopPropagation())
        },errorChat: function(b) {
            var c = this, d = new l({err_msg: b});
            d.on(h, function(a) {
                c.trigger(h, a)
            }), d.render();
            ...
            var b = new d({el: g,className: "common-pop-error",title: e.getMessage("guild_main_145"),body: a,flagBtnCancel: 0,flagBtnOk: 1});
            b.on("ok", function() {
                b.popRemove()
            }), b.render().popShow()
            ...
            var a = new d({el: g,className: "send-chat",title: e.getMessage("guild_main_103"),body: e.getMessage("guild_main_106"),flagBtnCancel: 0,flagBtnOk: 1});
            a.on("ok", function() {
                a.popRemove()
            }), a.render().popShow()
        },destroy: function() {
        ...
        l = k.extend({
            ...
            initialize: function() {
                ...
                return this.renderPopup(), this.$frmMessage = a("#frm-message"), this
            },create: function(a) {
                var b = this;
                (void 0 == a || "" == a) && (a = e.getMessage("guild_main_107")), 1 == a && (a = "");
                var c = {inputText: this.inputComment,errflag: !0,msg: a,count_max: f};
                this.popView = new d({el: g,className: "ready-chat",title: e.getMessage("guild_main_108"),body: this.template(c),flagBtnCancel: 1,flagBtnOk: 1}), this.popView.on("ok", function() {
                    b.popView.popOff(), b.popView.popRemove(), b.checkMessage()
                }), this.popView.on("cancel", function() {
                    b.popView.popRemove()
                })
            },renderPopup: function() {
                this.popView.render().popShow(), this.setElement(".ready-chat")
            }});
    return k
});
define('collection/data', ["backbone", "underscore", "util/ajax"], function(a, b, c) {
    var d = a.Collection.extend({initialize: function(a, b) {
        ...
        c.isManuallyAbortedXHR(b) || (404 === b.status && null === b.getResponseHeader("Content-Length") && (b.status = 0), 409 != b.status && 410 != b.status && (Game.reportError("[DataCollection] response status " + b.status, a.url() || d.url), d.ignoreError || Game.view.trigger("data_error")))
    },sync: function(b, c, d) {
        return d = d || {}, d.cache = d.cache || !1, a.Collection.prototype.sync.apply(this, arguments)
    }});
    return d
});
define('view/chat/stamp', ["jquery", "underscore", "backbone", "view/popup", "collection/data", "model/sound", "util/local-storage", "flexslider", "util/language-message"], function(a, b, c, d, e, f, g, h, i) {
    var j = "#pop-chat", k = "pop-ready-stamp", l = !1, m = "submit", n = c.View.extend({el: "#general-chat .chat-stamp",events: {"tap #chat-stamp:not(.disable)": "fetchStampCollection"},initialize: function() {
        this.$stamp = this.$el.find("#chat-stamp"), this.stampCollectionRequest = new (e.extend({url: Game.baseUri + "profile/stamp_list/"}))
        ...
        var b = new o({stampList: a.stampCollection});
        b.on(m, function(b) {
            a.trigger(m, b)
        }), b.render()
    },popIntervalErrorDialog: function() {
        var a = new d({el: j,className: "common-pop-error",title: i.getMessage("guild_main_145"),body: i.getMessage("guild_main_146"),flagBtnCancel: 0,flagBtnOk: 1});
        a.on("ok", function() {
            a.popRemove()
        }), a.render().popShow()
    },popCompletionDialog: function() {
        var a = new d({el: j,className: "send-stamp",title: i.getMessage("guild_main_103"),body: i.getMessage("guild_main_114"),flagBtnCancel: 0,flagBtnOk: 1,btnOkClassName: "btn-stamp-ok"});
        a.on("ok", function() {
            a.popRemove()
        }), a.render().popShow()
    },destroy: function() {
        this.off(), this.undelegateEvents(), this.stopListening()
    }}), o = c.View.extend({el: "",postFlag: !1,postStampId: 0,events: {"tap .img-stamp": "postStamp","tap .btn-usual-ok": "closePopup","tap .btn-usual-cancel": "closePopup"},initialize: function() {
        var c, e = this, f = {};
        c = b.filter(this.options.stampList, function(a) {
            return +a.priority <= 32
        }), c = b.sortBy(c, function(a) {
            return +a.priority
        }), f.stampList = c, f.showRecentStamps = g.isSupported(), f.showRecentStamps && (f.recentStamps = e.getRecentStamps()), this.popView = new d({el: j,className: k,title: i.getMessage("guild_main_147"),body: b.template(a("#tpl-stamp").html(), f),flagBtnCancel: 1,flagBtnOk: 0}), this.popView.on("removeEnd", function() {
            e.postFlag && (e.trigger(m, {stamp_id: e.postStampId}), e.setLatestStamp())
        })
    },render: function() {
        this.renderPopup(k), a(".prt-stamp-wrapper .lis-stamp-slider").hide(), a(".prt-stamp-image").flexslider({selector: ".prt-stamp-wrapper > .lis-stamp-slider",animation: "slide",animationLoop: !1,slideshow: !1,prevText: "",nextText: "",start: function() {
            a(".prt-stamp-wrapper .lis-stamp-slider").show()
        }});
        var b = Number(a("html").css("zoom")), c = a(document).scrollTop();
        return Game.ua.isJssdk() && (b = 1 >= b ? Number(a("#mobage-game-container").css("zoom")) : b, c = a("#mobage-game-container").parent().scrollTop()), a("." + k).css("top", c / b + 20 + "px"), this
    },postStamp: function(b) {
        l !== !0 && (l = !0, setTimeout(function() {
            l = !1
        }, 5e3), this.postFlag || (this.postFlag = !0, f.playPushStampSE(), this.postStampId = a(b.currentTarget).data("stamp-id"), g.isSupported() && this.prepareLatestStamp(this.postStampId), this.closePopup()))
    },getRecentStamps: function() {
        var a, c, d = this, e = [], f = 16;
        if (d.recentStamps = d.recentStamps || [], a = g.getItem("recentStamps"), a && (a = JSON.parse(a)), !a) {
            for (c = 0; f > c; c++)
                e[c] = 0;
            g.setObject("recentStamps", e), a = e
        }
        for (c = 0; f > c; c++)
            d.recentStamps[c] = b.find(d.options.stampList, function(b) {
                return +b.id === a[c]
            }), void 0 === d.recentStamps[c] && (d.recentStamps[c] = {id: "0"});
        ...
        if (a = f.preparedLatestStamp || null, null !== a) {
            for (d = f.getRecentStamps(), c = b.filter(d, function(b) {
                ...
                void 0 === c[e] && (c[e] = {id: "0"}), h[e + 1] = +c[e].id;
            h[0] = a, g.setObject("recentStamps", h)
        }
    },renderPopup: function(a) {
        this.popView.render().popShow(), this.setElement("." + a)
    },closePopup: function() {
...
define('util/language', ["underscore"], function(a) {
    ...
    return {isJapanese: a.partial(b, "ja"),isEnglish: a.partial(b, "en")}
});
define('model/chat', ["jquery", "underscore", "backbone", "util/language"], function(a, b, c, d) {
    var e = "/sp/assets/stamp/full/", f = "<img", g = c.Model.extend({PAGE_DEFAULT: 1,LIMIT_DEFAULT: 30,infoModel: null,commentListModel: null,postFormModel: null,postStampModel: null,fetchInfo: function() {
        return this.infoModel.fetch()
    },fetchCommentList: function() {
        var c = this, d = new a.Deferred;
        ...
        if (a.userId && a.chatTime && a.nickname && a.userImage && a.commentData)
            return b.isObject(a.commentData.content) && (a.commentData.content = a.commentData.content[Game.lang]), a.commentData.isStamp && !this.isImgTag(a.commentData.content) && (a.commentData.content = this.toStampTag(a.commentData.content)), a;
        ...
        return {id: a.id,userId: a.user_id,platformId: a.platform_id,chatTime: a.chat_time,nickname: a.user_name,userImage: a.user_image,categoryId: a.category_id,chatId: a.chat_id,commentFrom: a.comment_from,commentData: {isStamp: a.user_comment.is_stamp,content: c},systemEvent: a.system_type}
    },toStampTag: function(a) {
        var b = Game.imgUri + e + a, c = '<img src="' + b + '" alt="" class="img-stamp">';
        return c
    },isImgTag: function(a) {
        var b = a.indexOf(f);
        return b >= 0
...
define('model/chat/guild', ["jquery", "underscore", "backbone", "model/data", "model/token-data", "model/chat"], function(a, b, c, d, e, f) {
    var g = f.extend({infoModel: new (d.extend({urlRoot: Game.baseUri + "guild/main/guild_info"})),postFormModel: new (e.extend({urlRoot: Game.baseUri + "guild_main/comment"})),postStampModel: new (e.extend({urlRoot: Game.baseUri + "guild_main/stamp"})),coopRoomLinkModel: new (e.extend({urlRoot: Game.baseUri + "coopraid/room_key"})),skycoopRoomLinkModel: new (e.extend({urlRoot: Game.baseUri + "sky/coopraid/room_key"})),initialize: function(a) {
        var b = a && a.page ? a.page : this.PAGE_DEFAULT, c = a && a.limit ? a.limit : this.LIMIT_DEFAULT;
        this.commentListModel = new (d.extend({urlRoot: Game.baseUri + "guild/main/comment_list/" + b + "/" + c}))
    },jumpToCoopRoom: function(a) {
        return this.coopRoomLinkModel.set({room_key: a}).save()
    },jumpToSkycoopRoom: function(a) {
        return this.skycoopRoomLinkModel.set({room_key: a}).save()
    }});
    return g
});
define('model/chat/raid', ["jquery", "underscore", "backbone", "model/data", "model/token-data", "model/chat"], function(a, b, c, d, e, f) {
    var g = f.extend({infoModel: null,commentListModel: null,postFormModel: new (e.extend({urlRoot: Game.baseUri + "multiraid/comment"})),postStampModel: new (e.extend({urlRoot: Game.baseUri + "multiraid/stamp"}))});
    return g
});
define('model/chat/coop', ["jquery", "underscore", "backbone", "model/data", "model/token-data", "model/chat"], function(a, b, c, d, e, f) {
    var g = f.extend({infoModel: new (d.extend({urlRoot: Game.baseUri + "coopraid/room_id"})),postFormModel: new (e.extend({urlRoot: Game.baseUri + "coopraid/comment"})),postStampModel: new (e.extend({urlRoot: Game.baseUri + "coopraid/stamp"})),initialize: function(a) {
        var b = a && a.page ? a.page : this.PAGE_DEFAULT, c = a && a.limit ? a.limit : this.LIMIT_DEFAULT;
        this.commentListModel = new (d.extend({urlRoot: Game.baseUri + "coopraid/chat_list/" + b + "/" + c}))
    }});
    return g
});
define('model/chat/defendorder', ["jquery", "underscore", "backbone", "model/data", "model/token-data", "model/chat"], function(a, b, c, d, e, f) {
    var g = f.extend({infoModel: new (d.extend({urlRoot: Game.baseUri + "defendorder/chat_info"})),commentListModel: new (d.extend({urlRoot: Game.baseUri + "defendorder/comment_list/0"})),postFormModel: new (e.extend({urlRoot: Game.baseUri + "defendorder/comment"})),postStampModel: new (e.extend({urlRoot: Game.baseUri + "defendorder/stamp"})),setLatestCommentId: function(a) {
        this.commentListModel.urlRoot = Game.baseUri + "defendorder/comment_list/" + a
    }});
    return g
});
define('event/arcarum001/config/config', {url: Game.baseUri + "arcarum001/",hash: "event/arcarum001/",bgmFileNameBase: "bgm/51_arcana_event_"});
define('model/chat/arcarum', ["jquery", "underscore", "event/arcarum001/config/config", "backbone", "model/data", "model/token-data", "model/chat"], function(a, b, c, d, e, f, g) {
    var h = g.extend({infoModel: new (e.extend({urlRoot: c.url + "chat/chat_info"})),commentListModel: new (e.extend({urlRoot: c.url + "chat/comment_list/0"})),postFormModel: new (f.extend({urlRoot: c.url + "chat/comment"})),postStampModel: new (f.extend({urlRoot: c.url + "chat/stamp"})),setLatestCommentId: function(a) {
...
define('model/chat/semiraid', ["jquery", "underscore", "backbone", "model/data", "model/token-data", "model/chat"], function(a, b, c, d, e, f) {
    var g = f.extend({commentListModel: new (d.extend({urlRoot: Game.baseUri + "semiraid/comment_list"})),postFormModel: new (e.extend({urlRoot: Game.baseUri + "semiraid/comment"})),postStampModel: new (e.extend({urlRoot: Game.baseUri + "semiraid/stamp"})),postChatModel: new (e.extend({urlRoot: Game.baseUri + "semiraid/raid_chat"})),setRaidId: function(a) {
        this.raidId = a, this.updateCommentListModelUrlRoot()
    },setLatestCommentId: function(a) {
        this.latestCommentId = a, this.updateCommentListModelUrlRoot()
...
!function(a) {
    ...
    return function b(a, c, d) {
    ...
    }, {"./on": 4,"./socket": 5,"./url": 6,backo2: 7,"component-bind": 8,"component-emitter": 9,debug: 10,"engine.io-client": 11,indexof: 42,"object-component": 43,"socket.io-parser": 46}],4: [function(a, b, c) {
        function d(a, b, c) {
            return a.on(b, c), {destroy: function() {
        ...
        b.exports = c = d;
        var l = {connect: 1,connect_error: 1,connect_timeout: 1,disconnect: 1,error: 1,reconnect: 1,reconnect_attempt: 1,reconnect_failed: 1,reconnect_error: 1,reconnecting: 1}, m = f.prototype.emit;
    ...
    }, {"./on": 4,"component-bind": 8,"component-emitter": 9,debug: 10,"has-binary": 38,"socket.io-parser": 46,"to-array": 50}],6: [function(a, b, c) {
        (function(c) {
            function d(a, b) {
    ...
    }, {debug: 10,parseuri: 44}],7: [function(a, b, c) {
        function d(a) {
        ...
        b.exports = d, d.names = [], d.skips = [], d.enable = function(a) {
            ...
            for (var c = (a || "").split(/[\s,]+/), e = c.length, f = 0; e > f; f++)
                a = c[f].replace("*", ".*?"), "-" === a[0] ? d.skips.push(new RegExp("^" + a.substr(1) + "$")) : d.names.push(new RegExp("^" + a + "$"))
        }, d.disable = function() {
            d.enable("")
        ...
        b.exports = a("./lib/")
    }, {"./lib/": 12}],12: [function(a, b, c) {
        b.exports = a("./socket"), b.exports.parser = a("engine.io-parser")
    }, {"./socket": 13,"engine.io-parser": 25}],13: [function(a, b, c) {
        (function(c) {
            function d(a, b) {
            ...
            b.exports = d, d.priorWebsocketSuccess = !1, g(d.prototype), d.protocol = j.protocol, d.Socket = d, d.Transport = a("./transport"), d.transports = a("./transports"), d.parser = a("engine.io-parser"), d.prototype.createTransport = function(a) {
                ...
                function b() {
                    ...
                    l || (h('probe transport "%s" opened', a), k.send([{type: "ping",data: "probe"}]), k.once("packet", function(b) {
                        if (!l)
    ...
    }, {"./transport": 14,"./transports": 15,"component-emitter": 9,debug: 22,"engine.io-parser": 25,indexof: 42,parsejson: 34,parseqs: 35,parseuri: 36}],14: [function(a, b, c) {
        function d(a) {
    ...
    }, {"component-emitter": 9,"engine.io-parser": 25}],15: [function(a, b, c) {
        (function(b) {
            function d(a) {
    ...
    }, {"./polling-jsonp": 16,"./polling-xhr": 17,"./websocket": 19,xmlhttprequest: 20}],16: [function(a, b, c) {
        (function(c) {
            function d() {
            }
            function e(a) {
        ...
        (function(c) {
            ...
            b.exports = e, b.exports.Request = f, k(e, i), e.prototype.supportsBinary = !0, e.prototype.request = function(a) {
                ...
                try {
                    if (l("xhr open %s: %s", this.method, this.uri), b.open(this.method, this.uri, this.async), this.supportsBinary && (b.responseType = "arraybuffer"), "POST" == this.method)
                        try {
    ...
    }, {"./polling": 18,"component-emitter": 9,
        "component-inherit": 21,debug: 22,xmlhttprequest: 20}],18: [function(a, b, c) {
        function d(a) {
            var b = a && a.forceBase64;
            (!j || b) && (this.supportsBinary = !1), e.call(this, a)
        }
        var e = a("../transport"), f = a("parseqs"), g = a("engine.io-parser"), h = a("component-inherit"), i = a("debug")("engine.io-client:polling");
        b.exports = d;
        var j = function() {
    ...
    }, {"../transport": 14,"component-inherit": 21,debug: 22,"engine.io-parser": 25,parseqs: 35,xmlhttprequest: 20}],19: [function(a, b, c) {
        function d(a) {
            var b = a && a.forceBase64;
            b && (this.supportsBinary = !1), e.call(this, a)
        }
        var e = a("../transport"), f = a("engine.io-parser"), g = a("parseqs"), h = a("component-inherit"), i = a("debug")("engine.io-client:websocket"), j = a("ws");
    ...
    }, {"../transport": 14,"component-inherit": 21,debug: 22,"engine.io-parser": 25,parseqs: 35,ws: 37}],20: [function(a, b, c) {
        var d = a("has-cors");
        ...
        (function(b) {
            ...
            c.encodePacket = function(a, c, f, h) {
                ...
                if ("string" == typeof a || void 0 === a) {
                    ...
                    var f = a.charAt(0);
                    return Number(f) == f && s[f] ? a.length > 1 ? {type: s[f],data: a.substring(1)} : {type: s[f]} : t
                }
    ...
    }, {"./keys": 26,after: 27,"arraybuffer.slice": 28,"base64-arraybuffer": 29,blob: 30,"has-binary": 31,utf8: 33}],26: [function(a, b, c) {
        ...
        b.exports = function(a, b, c) {
            ...
            if (b = b || 0, c = c || d, a.slice)
                return a.slice(b, c);
            if (0 > b && (b += d), 0 > c && (c += d), c > d && (c = d), b >= d || b >= c || 0 === d)
                return new ArrayBuffer(0);
            for (var e = new Uint8Array(a), f = new Uint8Array(c - b), g = b, h = 0; c > g; g++, h++)
                f[h] = e[g];
            return f.buffer
        }
    }, {}],29: [function(a, b, c) {
            ...
            !function(e) {
                ...
                function g(a) {
                    for (var b, c = a.length, d = -1, e = ""; ++d < c; )
                        b = a[d], b > 65535 && (b -= 65536, e += t(b >>> 10 & 1023 | 55296), b = 56320 | 1023 & b), e += t(b);
                    return e
                }
                function h(a, b) {
                    return t(a >> b & 63 | 128)
                ...
                function l() {
                    ...
                    if (224 == (240 & a)) {
                        if (b = k(), c = k(), e = (15 & a) << 12 | b << 6 | c, e >= 2048)
                            return e;
                        throw Error("Invalid continuation byte")
                    }
                    if (240 == (248 & a) && (b = k(), c = k(), d = k(), e = (15 & a) << 18 | b << 12 | c << 6 | d, e >= 65536 && 1114111 >= e))
                        return e;
    ...
    }, {"./is-buffer": 47,isarray: 48}],46: [function(a, b, c) {
        function d() {
        }
        function e(a) {
            var b = "", d = !1;
    ...
    }, {"./binary": 45,"./is-buffer": 47,"component-emitter": 9,debug: 10,isarray: 48,json3: 49}],47: [function(a, b, c) {
        (function(a) {
            function c(b) {
        ...
        !function(b) {
            ...
            if (!c("json")) {
                ...
                if (!l)
                    var u = Math.floor, v = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334], w = function(a, b) {
                ...
                if (f = function(a, b) {
                    ...
                    var z = {92: "\\\\",34: '\\"',8: "\\b",12: "\\f",10: "\\n",13: "\\r",9: "\\t"}, A = "000000", B = function(a, b) {
                        ...
                        if ("object" == typeof l && l)
                            if (m = h.call(l), m != o || e.call(l, "toJSON"))
                                ...
                                if (w) {
                                    ...
                                    n = l.getUTCFullYear(), t = l.getUTCMonth(), v = l.getUTCDate(), y = l.getUTCHours(), z = l.getUTCMinutes(), A = l.getUTCSeconds(), C = l.getUTCMilliseconds();
                                l = (0 >= n || n >= 1e4 ? (0 > n ? "-" : "+") + B(6, 0 > n ? -n : n) : B(4, n)) + "-" + B(2, t + 1) + "-" + B(2, v) + "T" + B(2, y) + ":" + B(2, z) + ":" + B(2, A) + "." + B(3, C) + "Z"
                            } else
                                l = null;
                        if (c && (l = c.call(b, a, l)), null === l)
                            return "null";
                        if (m = h.call(l), m == s)
                            return "" + l;
                        if (m == p)
                        ...
                        if ("object" == typeof l) {
                            ...
                            if (k.push(l), F = [], J = j, j += i, m == r) {
                                for (H = 0, I = l.length; I > H; H++)
                                    G = E(H, l, c, d, i, j, k), F.push(G === g ? "null" : G);
                                K = F.length ? i ? "[\n" + j + F.join(",\n" + j) + "\n" + J + "]" : "[" + F.join(",") + "]" : "[]"
                            } else
                                f(d || l, function(a) {
                ...
                if (!c("json-parse")) {
                    var F, G, H = String.fromCharCode, I = {92: "\\",34: '"',47: "/",98: "\b",116: "	",110: "\n",102: "\f",114: "\r"}, J = function() {
                                    ...
                                    for (a = "@", F++; g > F; )
                                        if (e = f.charCodeAt(F), 32 > e)
                                            ...
                                            switch (e = f.charCodeAt(++F)) {
                                                ...
                                                case 117:
                                                    for (b = ++F, c = F + 4; c > F; F++)
                                                        e = f.charCodeAt(F), e >= 48 && 57 >= e || e >= 97 && 102 >= e || e >= 65 && 70 >= e || J();
                                                    a += H("0x" + f.slice(b, F));
                                                    break;
                                                default:
                                                    J()
                                            ...
                                            if (34 == e)
                                                break;
                                            for (e = f.charCodeAt(F), b = F; e >= 32 && 92 != e && 34 != e; )
                                                e = f.charCodeAt(++F);
                                            a += f.slice(b, F)
                                        }
                                ...
                                default:
                                    if (b = F, 45 == e && (d = !0, e = f.charCodeAt(++F)), e >= 48 && 57 >= e) {
                                        ...
                                        if (e = f.charCodeAt(F), 101 == e || 69 == e) {
                                            for (e = f.charCodeAt(++F), (43 == e || 45 == e) && F++, c = F; g > c && (e = f.charCodeAt(c),
                                            e >= 48 && 57 >= e); c++)
                                                ;
                                            c == F && J(), F = c
                                        }
                        ...
                        if ("$" == a && J(), "string" == typeof a) {
                            ...
                            if ("[" == a) {
                                for (b = []; a = K(), "]" != a; c || (c = !0))
                                    c && ("," == a ? (a = K(), "]" == a && J()) : J()), "," == a && J(), b.push(L(a));
                                return b
                            }
                            if ("{" == a) {
                                for (b = {}; a = K(), "}" != a; c || (c = !0))
                                    c && ("," == a ? (a = K(), "}" == a && J()) : J()), ("," == a || "string" != typeof a || "@" != (t ? a.charAt(0) : a[0]) || ":" != K()) && J(), b[a.slice(1)] = L(K());
                                return b
                            }
                            J()
                        }
...
define('model/socket', ["jquery", "underscore", "backbone", "socketio", "util/ajax", "model/data", "model/token-data"], function(a, b, c, d, e, f, g) {
    var h = 5, i = 1e4, j = 5e3, k = "nickname", l = {}, m = {}, n = {}, o = {}, p = c.Model.extend({defaults: {room: "",socketUriController: ""},socketUriPrefix: Game.baseUri + "socket/uri/",initialize: function() {
        this.customEvents = {}, this.connect(), this.pendingEvents = []
    },getUuriCount: function() {
        var a = this.uuri;
        return b.has(n, a) ? n[a] : 0
    },getQuery: function() {
        var c = this, d = new a.Deferred, e = b.uniqueId();
        return o[e] = (new (f.extend({urlRoot: Game.baseUri + "socket/query"}))).fetch({ignoreError: !0}).done(function(a) {
            d.resolve(b.extend({room: a.prefix + c.get("room"),nickname: encodeURIComponent(a[k])}, a)), delete o[e]
        }), d
    },getSocketUri: function() {
        var c = this, d = new a.Deferred, e = b.uniqueId(), g = c.get("socketUriController"), h = g ? Game.baseUri + "socket/" + g + "/uri/" : this.socketUriPrefix;
        return o[e] = (new (f.extend({urlRoot: h + c.get("room")}))).fetch({ignoreError: !0}).done(function(a) {
            d.resolve(a), delete o[e]
        }), d
    },resetToken: function() {
        var b = this, c = new a.Deferred;
        return b.getQuery().done(function(a) {
            c.resolve(a)
        }), c
    },delayedConnect: function() {
        var a = this;
        a.destroySocket(), a.destroyed || (window.clearTimeout(a.connectTimer), a.connectTimer = window.setTimeout(function() {
            a.connect()
        }, i))
    },delayedReconnect: function() {
        var a = this;
        a.destroySocket(), a.destroyed || (window.clearTimeout(a.reconnectTimer), a.reconnectTimer = window.setTimeout(function() {
            a.reconnect()
        }, i))
    },delayedDisconnect: function() {
        var a = this, c = a.uuri;
        b.has(m, c) && clearTimeout(m[c]), m[c] = setTimeout(function() {
            0 === a.getUuriCount() && l[c].disconnect(), delete m[c]
        }, j)
    },handleConnect: function() {
        var a = this;
        a.resetRetryCount(), a.bindCustomEvents(a.socket), b.each(a.pendingEvents, function(b) {
            a.socket.emit(b.event, b.data)
        })
    },tryDelayedConnect: function() {
        var b = this;
        b.retryCount = b.retryCount || 0, b.retryCount++ < h ? b.delayedConnect() : a(window).one("touchstart", function() {
            b.resetRetryCount(), b.delayedConnect()
        })
    },bindEvents: function(a) {
        var c = this, d = c.ioEvents = {connect: [],disconnect: [],connect_error: [],reconnect_error: [],error: [],connect_timeout: [],reconnect_failed: []};
        ...
        var c = this;
        a = a || c.socket, a && b.each(c.customEvents, function(c, d) {
            b.each(c, function(b) {
                a.off ? a.off(d, b) : a.removeListener && a.removeListener(d, b), a.on(d, b)
            })
        })
        ...
        a.when(c.getSocketUri(), c.getQuery()).done(function(a, e) {
            ...
            if (!c.destroyed) {
                var g;
                b.has(l, f) ? (g = c.socket = l[f], g.io.opts.query.token = e.token, g.connect()) : (g = c.socket = d.connect(a, {reconnect: !1,"max reconnection attempts": 1,reconnection: !1,reconnectionAttempts: 1,"force new connection": !0,multiplex: !1,query: e}), l[f] = g), c.bindEvents(g), n[f] = c.getUuriCount() + 1, g.connected && c.triggerSocket("connect")
            }
        })
    },reconnect: function() {
        var a = this;
        a.socket && a.resetToken().done(function() {
            a.bindEvents(a.socket), a.socket.reconnect()
        })
        ...
        var a = this, c = a.socket, d = a.uuri;
        if (c) {
            var e = function(a) {
            ...
            e(a.customEvents), e(a.ioEvents), 0 === (n[d] = a.getUuriCount() - 1) && a.delayedDisconnect()
        }
    },destroy: function() {
        var a = this;
        a.destroyed = !0, window.clearTimeout(a.connectTimer), window.clearTimeout(a.reconnectTimer), a.abortXHR(), a.destroySocket(), delete a.ioEvents, delete a.customEvents, delete a.pendingEvents, delete a.socket, delete a.connectTimer, delete a.reconnectTimer
    },onSocket: function(a, b) {
        var c = this;
        c.socket && c.socket.on(a, b), c.customEvents[a] || (c.customEvents[a] = []), c.customEvents[a].push(b)
    },triggerSocket: function(a, c) {
        var d = this, e = d.customEvents;
        e && e[a] && b.each(e[a], function(a) {
            a.call(d.socket, c)
        })
    },emit: function(a, c) {
        c = b.defaults(c || {}, {room: this.get("room")});
        var d = this;
        d.socket ? d.socket.emit(a, c) : d.pendingEvents.push({event: a,data: c})
...
!function(a, b, c) {
    ...
    var g = a.requestAnimationFrame || a.webkitRequestAnimationFrame || a.mozRequestAnimationFrame || a.oRequestAnimationFrame || a.msRequestAnimationFrame || function(b) {
        ...
        e.getTime = Date.now || function() {
            ...
            return g = void 0 === g ? 6e-4 : g, h = a + k * k / (2 * g) * (0 > j ? -1 : 1), i = k / g, e > h ? (h = f ? e - f / 2.5 * (k / 8) : e, j = c.abs(h - a), i = j / k) : h > 0 && (h = f ? f / 2.5 * (k / 8) : 0, j = c.abs(a) + h, i = j / k), {destination: c.round(h),duration: i}
        };
        var h = d("transform");
        return e.extend(e, {hasTransform: h !== !1,hasPerspective: d("perspective") in f,hasTouch: "ontouchstart" in a,hasPointer: a.PointerEvent || a.MSPointerEvent,hasTransition: d("transition") in f}), e.isBadAndroid = /Android /.test(a.navigator.appVersion) && !/Chrome\/\d/.test(a.navigator.appVersion), e.extend(e.style = {}, {transform: h,transitionTimingFunction: d("transitionTimingFunction"),transitionDuration: d("transitionDuration"),transitionDelay: d("transitionDelay"),transformOrigin: d("transformOrigin")}), e.hasClass = function(a, b) {
            ...
            for (var c in b)
                if (b[c].test(a[c]))
                    return !0;
            return !1
        }, e.extend(e.eventType = {}, {touchstart: 1,touchmove: 1,touchend: 1,mousedown: 2,mousemove: 2,mouseup: 2,pointerdown: 3,pointermove: 3,pointerup: 3,MSPointerDown: 3,MSPointerMove: 3,MSPointerUp: 3}), e.extend(e.ease = {}, {quadratic: {style: "cubic-bezier(0.25, 0.46, 0.45, 0.94)",fn: function(a) {
            return a * (2 - a)
    ...
    d.prototype = {version: "5.1.3",_init: function() {
        ...
        if (this.enabled && h.eventType[a.type] === this.initiated) {
            ...
            if (this.isInTransition = 0, this.initiated = 0, this.endTime = h.getTime(), !this.resetPosition(this.options.bounceTime)) {
                if (this.scrollTo(f, g), !this.moved)
                    return this.options.tap && h.tap(a, this.options.tap), this.options.click && h.click(a), void this._execEvent("scrollCancel");
                if (this._events.flick && 200 > e && 100 > i && 100 > j)
                    return void this._execEvent("flick");
                if (this.options.momentum && 300 > e && (b = this.hasHorizontalScroll ? h.momentum(this.x, this.startX, e, this.maxScrollX, this.options.bounce ? this.wrapperWidth : 0, this.options.deceleration) : {destination: f,duration: 0}, d = this.hasVerticalScroll ? h.momentum(this.y, this.startY, e, this.maxScrollY, this.options.bounce ? this.wrapperHeight : 0, this.options.deceleration) : {destination: g,duration: 0}, f = b.destination, g = d.destination, k = c.max(b.duration, d.duration), this.isInTransition = 1), this.options.snap) {
        ...
        return this.options.useTransform ? (d = d[h.style.transform].split(")")[0].split(", "), b = +(d[12] || d[4]), c = +(d[13] || d[5])) : (b = +d.left.replace(/[^-\d.]/g, ""), c = +d.top.replace(/[^-\d.]/g, "")), {x: b,y: c}
        ...
        this.indicators = [], this.options.scrollbars && (this.options.scrollY && (b = {el: e("v", c, this.options.scrollbars),interactive: c,defaultScrollbars: !0,customStyle: d,resize: this.options.resizeScrollbars,shrink: this.options.shrinkScrollbars,fade: this.options.fadeScrollbars,listenX: !1}, this.wrapper.appendChild(b.el), g.push(b)), this.options.scrollX && (b = {el: e("h", c, this.options.scrollbars),interactive: c,defaultScrollbars: !0,customStyle: d,resize: this.options.resizeScrollbars,shrink: this.options.shrinkScrollbars,fade: this.options.fadeScrollbars,listenY: !1}, this.wrapper.appendChild(b.el), g.push(b))), this.options.indicators && (g = g.concat(this.options.indicators));
        ...
        if (this.enabled) {
            ...
            if (b *= this.options.invertWheelDirection, d *= this.options.invertWheelDirection, this.hasVerticalScroll || (b = d, d = 0), this.options.snap)
                return e = this.currentPage.pageX, f = this.currentPage.pageY, b > 0 ? e-- : 0 > b && e++, d > 0 ? f-- : 0 > d && f++, void this.goToPage(e, f);
                ...
                if (this.options.snap === !0)
                    for (d = c.round(k / 2), e = c.round(l / 2); j > -this.scrollerWidth; ) {
                        for (this.pages[h] = [], a = 0, f = 0; f > -this.scrollerHeight; )
                            this.pages[h][a] = {x: c.max(j, this.maxScrollX),y: c.max(f, this.maxScrollY),width: k,height: l,cx: j - d,cy: f - e}, f -= l, a++;
                        j -= k, h++
                    }
                else
                    for (g = this.options.snap, a = g.length, b = -1; a > h; h++)
                        (0 === h || g[h].offsetLeft <= g[h - 1].offsetLeft) && (i = 0, b++), this.pages[i] || (this.pages[i] = []), j = c.max(-g[h].offsetLeft, this.maxScrollX), f = c.max(-g[h].offsetTop, this.maxScrollY), d = j - c.round(g[h].offsetWidth / 2), e = f - c.round(g[h].offsetHeight / 2), this.pages[i][b] = {x: j,y: f,width: g[h].offsetWidth,height: g[h].offsetHeight,cx: d,cy: e}, j > this.maxScrollX && i++;
...
define("view/chat", ["jquery", "underscore", "backbone", "view/chat/form", "view/chat/stamp", "model/data", "model/token-data", "model/chat/guild", "model/chat/raid", "model/chat/coop", "model/chat/defendorder", "model/chat/arcarum", "model/chat/semiraid", "model/socket", "util/local-storage", "lib/iscroll"], function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
    var p = {OFF: 0,LIGHT: 1,NORMAL: 2}, q = "chat", r = "guildPost", s = "raidPost", t = "coopPost", u = "raidGet", v = "raid", w = "chatAdd", x = {GUILD: "guild",COOP: "coop",RAID: "raid",DEFENDORDER: "defendorder"}, y = {GUILD: "chat/guild",COOP: "chat/coop",RAID: "chat/raid",DEFENDORDER: "chat/defendorder"}, z = {GUILD: 0,COOP: 1,RAID: 2,DEFENDORDER: 3,ARCARUM: 4}, A = "chatState", B = {DEFAULT: 0,HALF: 1,FULL: 2}, C = {OPEN: "open",INPUT: "input",BUTTON: "btn-general-chat",SELECTED: "selected",GUILD: "guild",COOP: "coop",RAID: "raid",DEFENDORDER: "defendorder",ARCARUM: "arcarum",HALF: "half",FULL: "full",PLAYER: "player",APP: "app",CHROME: "chrome",SHELL: "shell"}, D = "commentSaved", E = "guildCommentAppended", F = "error", G = 9999, H = 5, I = a("#tpl-chat-log").html(), J = 3e3, K = 3e3, L = 500, M = "room-key", N = c.View.extend({el: "#general-chat",CHANNEL_GUILD: z.GUILD,CHANNEL_COOP: z.COOP,CHANNEL_RAID: z.RAID,guildId: 0,raidId: 0,coopId: 0,defendorderId: 0,currentChannel: z.GUILD,lastChannel: z.GUILD,logState: B.FULL,timeoutIdHash: {},openFlag: !1,enabledFlag: !1,destroyFlag: !1,events: {"tap #chat-open": "openChatFromUser","tap #chat-close": "closeChat","tap #chat-close-alter": "closeChat","tap #chat-body:not(.half):not(.full) #chat-switch": "switchLogHalf","tap #chat-body.half #chat-switch": "switchLogFull","tap #chat-body.full #chat-switch": "switchLogHalf","tap #chat-body.full #chat-switch-alter": "switchLogHalf","tap #chat-guild": "changeChannelToGuild","tap #chat-coop": "changeChannelToCoop","tap #chat-raid": "changeChannelToRaid","tap #chat-defendorder": "changeChannelToDefendorder","tap #chat-arcarum": "changeChannelToArcarum","tap .link-chat-log.coop-room:not(.sky)": "onTapCoopRoomLink","tap .link-chat-log.coop-room.sky": "onTapSkycoopRoomLink","tap .link-chat-log.assistance": "onTapAssistanceLink","tap #chat-stamp:not(.disable)": "onTapStamp"},initialize: function() {
        var b = this;
        b.cacheDOM(["body", "header", "content", "footer", "log", "input", "send", "guild", "coop", "raid", "defendorder", "arcarum"]), b.$channelButtons = b.$el.find("#chat-header-left .btn-general-chat"), b.$buttons = b.$el.find(".btn-general-chat"), b.logScroller = new IScroll(b.$content[0], {mouseWheel: !0}), b.$input.on("focus", function() {
            b.$body.addClass(C.INPUT), b.$input.removeClass(C.BUTTON), b.logScroller.refresh(), b.scrollLog(L)
        }).on("blur", function() {
            b.$body.removeClass(C.INPUT), b.$buttons.removeClass("on"), b.$input.addClass(C.BUTTON), b.logScroller.refresh()
        }), b.$content.on("tap", function() {
            b.formView.blurInput(!0)
        }), a(".chat-mask").on("touchmove", function(a) {
            a.preventDefault()
        }).on("tap", function(a) {
            b.formView.blurInput(!0), a.preventDefault()
        }), b.guildModel = new h, b.coopModel = new j, b.defendorderModel = new k, b.arcarumModel = new l, b.addAppClass(), b.createSubView(), b.disableChat()
    },cacheDOM: function(a, c) {
        var d = this;
        c = c || "#chat-", b.each(a, function(a) {
            d["$" + a] = d.$el.find(c + a)
        })
    },addAppClass: function() {
        (Game.ua.isChromeApp() || Game.setting.is_enable_pc_footer) && this.$el.addClass(C.APP + " " + C.CHROME), Game.shellAppFlag && this.$el.addClass(C.APP + " " + C.SHELL)
    },createSubView: function() {
        var a = this;
        this.formView = new d, this.formView.on("submit", function(b) {
            a.onSubmitForm(b)
        }).on("submissionEmptyError submissionExcessError", function(b) {
            a.formView.popErrorDialog(b)
        }), this.stampView = new e, this.stampView.on("submit", function(b) {
            a.onSubmitStamp(b)
        }).on("error", function() {
            a.trigger(F)
        })
        ...
        b.fetchGuildInfo().done(function() {
            ...
            b.guildId ? b.fetchCommentList(b.guildModel).done(function(a) {
                b.currentChannel === z.GUILD && (b.clearComments(), b.appendComments(a), b.initializeSocket(x.GUILD + b.guildId, y.GUILD))
            }) : b.disableChat()
        })
    },setupCoopChannel: function() {
        var a = this;
        a.fetchCoopInfo().done(function(b) {
            a.coopId = b, a.coopId ? a.fetchCommentList(a.coopModel).done(function(b) {
                a.currentChannel === z.COOP && (a.clearComments(), a.appendComments(b), a.initializeSocket(x.COOP + a.coopId, y.COOP))
            }) : a.disableChat()
        })
    },setupRaidChannel: function(a) {
        var b = this, c = location.hash.split("/"), d = b.openFlag && b.currentChannel === z.RAID;
        delete b.raidModel, b.raidId = c[1], "#raid_multi" === c[0] ? (b.raidModel = new i, b.clearComments(), b.initializeSocket(x.RAID + b.raidId, y.RAID)) : d && b.disableChat()
        ...
        b.defendorderModel.fetchInfo().done(function(c) {
            ...
            d && b.destroySocket(), c.defendorder_id ? (a && d || (b.defendorderId = c.defendorder_id, b.latestDefendorderCommentId = 0, b.updateDefendorderCommentList(!0)), d && b.enableChat()) : d && b.disableChat()
        })
    },setupArcarumChannel: function() {
        var a = this, b = 0, c = 1, d = 2;
        a.arcarumModel.fetchInfo().done(function(e) {
            e === c ? (a.enableChat(), a.updateArcarumCommentList(!0)) : e === b ? a.disableChat() : e === d && (a.disableChat(), a.changeChannelToGuild())
        })
    },updateSemiraidCommentList: function(a) {
        var c = this;
        clearTimeout(c.semiraidUpdateTimeoutId), c.semiraidUpdateTimeoutId = void 0, "#raid_semi" === location.hash.split("/")[0] && (Game.setting.rtn_mode || c.openFlag && c.currentChannel == z.RAID) && (Game && Game.view && Game.view.setupView ? (c.raidModel.setLatestCommentId(c.latestRaidCommentId), c.fetchCommentList(c.raidModel).done(function(d) {
            if (d = b.reject(d, function(a) {
                ...
                if (window.stage && window.stage.pJsnData && b.each(d, function(a) {
                    ...
                    e = b.chain(e).shuffle().last(H).value(), b.each(e, function(a) {
                        c.postChatToRaid(a)
                    })
                }
                c.latestRaidCommentId = b.last(d).id, c.openFlag && c.currentChannel === z.RAID && c.appendComments(d)
            }
        ...
        var c = this;
        clearTimeout(c.defendorderUpdateTimeoutId), c.defendorderUpdateTimeoutId = void 0;
        var d = location.hash.split("/"), e = d[1] && "island" === d[1] && "#defend_order" === d[0], f = c.openFlag && c.currentChannel == z.DEFENDORDER;
        (e || f) && (c.defendorderModel.setLatestCommentId(c.latestDefendorderCommentId), c.fetchCommentList(c.defendorderModel).done(function(d) {
            ...
            }), d.length > 0 && (c.latestDefendorderCommentId = b.last(d).id, f && c.appendComments(d)), c.defendorderUpdateTimeoutId = setTimeout(function() {
        ...
        return function(d) {
            ...
            d && (c = 0), clearTimeout(a), f() && (e.arcarumModel.setLatestCommentId(c), e.fetchCommentList(e.arcarumModel).done(function(d) {
                d = b.reject(d, function(a) {
                    return a.id <= c
                }), d.length > 0 && (c = b.last(d).id, f() && e.appendComments(d)), a = setTimeout(function() {
                    e.updateArcarumCommentList(!1)
                }, K)
            }))
        }
    }(),postChatToRaid: function(a) {
        var b = {name: a.nickname};
        a.categoryId && a.chatId ? b.chat = stage.pJsnData.chat[a.categoryId][a.chatId] : b.chat = {text: a.commentData.content}, Game.view.setupView.displayChat(null, b)
    },fetchGuildInfo: function() {
        var b = this, c = new a.Deferred, d = function() {
            b.guildModel.fetchInfo().done(function(a) {
                b.guildId = a.is_guild_in, c.resolve()
            }).fail(function() {
                if (b.destroyFlag)
                    return c.reject();
        ...
        var c = this, d = new a.Deferred, e = function() {
        ...
        switch (c.currentChannel) {
            ...
            case z.COOP:
                ...
                break;
            case z.RAID:
                c.raidModel.postForm(b.extend(a, {raid_id: c.raidId})).done(function(a) {
                    c.onSaveForm(a, z.RAID), stage.pJsnData.is_semi && c.updateSemiraidCommentList()
                });
                break;
            case z.DEFENDORDER:
                c.defendorderModel.postForm(b.extend(a, {defendorder_id: c.defendorderId})).done(function(a) {
                    c.onSaveForm(a, z.DEFENDORDER), c.updateDefendorderCommentList()
                });
                break;
            case z.ARCARUM:
                c.arcarumModel.postForm(a).done(function(a) {
                    c.onSaveForm(a, z.ARCARUM), c.updateArcarumCommentList()
                })
        }
        ...
        switch (c.currentChannel) {
            ...
            case z.COOP:
                ...
                break;
            case z.RAID:
                c.raidModel.postStamp(b.extend(a, {raid_id: c.raidId})).done(function(a) {
                    c.onSaveStamp(a, z.RAID), stage.pJsnData.is_semi && c.updateSemiraidCommentList()
                });
                break;
            case z.DEFENDORDER:
                c.defendorderModel.postStamp(b.extend(a, {defendorder_id: c.defendorderId})).done(function(a) {
                    c.onSaveStamp(a, z.DEFENDORDER), c.updateDefendorderCommentList()
                });
                break;
            case z.ARCARUM:
                c.arcarumModel.postStamp(a).done(function(a) {
                    c.onSaveStamp(a, z.ARCARUM), c.updateArcarumCommentList()
                })
        }
    },onSaveForm: function(a, b) {
        return a.error === !0 ? this.formView.popErrorDialog(a.message) : void this.trigger(D, {channel: b})
    },onSaveStamp: function(a, b) {
        this.trigger(D, {channel: b})
        ...
        var c = this, d = new O(a);
        c.$log.append(d.render().el), b !== !1 && setTimeout(function() {
            c.scrollLog(L)
        }, 50)
    },scrollLog: function(a) {
        this.logScroller.refresh(), this.logScroller.scrollTo(0, this.logScroller.maxScrollY, a)
    },clearComments: function() {
        this.$log.html('<div id="chat-blank"></div>'), this.logScroller.refresh()
    },initializeSocket: function(a, c) {
        var d = this;
        d.destroySocket();
        var e = d.socket = new n({room: a,socketUriController: c}), f = {}, g = {};
        f[r] = function(a) {
            d.currentChannel === z.GUILD && (a = d.guildModel.parseComment(a), d.appendComment(a), d.trigger(E))
        }, f[t] = function(a) {
            d.currentChannel === z.COOP && (a = d.coopModel.parseComment(a), d.appendComment(a))
        }, f[s] = function(a) {
            d.currentChannel === z.RAID && (a = d.raidModel.parseComment(a), d.appendComment(a))
        }, f[u] = function(a) {
            d.$log.find(".lis-log").length || (b.each(a, function(a) {
                a = d.raidModel.parseComment(a), d.appendComment(a, !1)
            }), setTimeout(function() {
                d.scrollLog(L)
            }, 100))
        ...
        this.enabledFlag = !1, this.formView.disable(), this.stampView.disable()
    },enableChat: function() {
        this.enabledFlag = !0, this.formView.enable(), this.stampView.enable()
    },openChat: function(a) {
        var b = this;
        b.openFlag = !0, b.$el.addClass(C.OPEN), b.$body.css({display: ""}), a !== !1 && b.changeChannelTo(b.currentChannel), b.trigger("openChat")
    },openChatFromUser: function(a) {
        a.preventDefault(), a.stopPropagation(), this.openChat()
    },closeChat: function(a) {
        var c = this;
        c.openFlag = !1, c.$el.removeClass(C.OPEN), c.$body.css({display: ""}), c.disableChat(), this.destroySocket(), b.each(b.keys(this.timeoutIdHash), function(a) {
            clearTimeout(a)
        }), this.timeoutIdHash = {}, this.saveState()
    },switchLog: function(a) {
        var c = this;
        switch (b.contains(B, a) && (c.logState = a), c.logState) {
            case B.DEFAULT:
        ...
        c.logScroller.refresh(), c.saveState(), c.trigger("switchLog")
        ...
        var a = [C.GUILD, C.COOP, C.RAID, C.DEFENDORDER, C.ARCARUM].join(" "), b = function() {
            var b = this;
            b.clearComments(), b.disableChat(), b.$channelButtons.removeClass(C.SELECTED), b.$body.removeClass(a)
        };
        return function(a, c) {
            var d = this;
            if (a === z.DEFENDORDER && 0 === d.$defendorder.length && (a = z.GUILD), d.currentChannel !== a || !c) {
                var e, f, g;
                switch (a) {
                    case z.GUILD:
                        e = d.$guild, f = C.GUILD, g = d.setupGuildChannel;
                        break;
                    case z.COOP:
                        e = d.$coop, f = C.COOP, g = d.setupCoopChannel;
                        break;
                    case z.RAID:
                        e = d.$raid, f = C.RAID, g = d.setupRaidChannel;
                        break;
                    case z.DEFENDORDER:
                        e = d.$defendorder, f = C.DEFENDORDER, g = d.setupDefendorderChannel;
                        break;
                    case z.ARCARUM:
                        e = d.$arcarum, f = C.ARCARUM, g = d.setupArcarumChannel;
                        break;
                    default:
                        return
                }
                d.currentChannel !== z.RAID && d.currentChannel !== a && (d.lastChannel = d.currentChannel), d.currentChannel = a, d.openFlag && (b.call(d), e.addClass(C.SELECTED), d.$body.addClass(f), g.call(d)), d.saveState()
            }
        }
        ...
        return this.formView.blurInput(), !1
    },saveState: function() {
        o.isSupported() && o.setObject(A, {openFlag: this.openFlag,channel: this.currentChannel,lastChannel: this.lastChannel,log: this.logState})
    },destroySocket: function() {
        this.socket && (this.socket.destroy(), delete this.socket)
    },destroy: function() {
        this.destroyFlag = !0, this.destroySocket(), this.off(), this.undelegateEvents(), this.stopListening(), this.stampView.destroy(), this.formView.destroy(), b.each(b.keys(this.timeoutIdHash), function(a) {
            clearTimeout(a)
        })
    }}), O = c.View.extend({tagName: "div",
        //template: b.template(I),
        template:'',
        className: function() {
        var a = ["lis-log"], b = Number(this.options.userId);
        return b === Game.userId && a.push(C.PLAYER), this.options.commentFrom && a.push(this.options.commentFrom), a.join(" ")
    },render: function() {
...
define("general/chat", ["jquery", "underscore", "backbone", "view/chat", "util/local-storage", "catalog/ua"], function(a, b, c, d, e, f) {
    var g = {OFF: 0,LIGHT: 1,NORMAL: 2}, h = null, i = function() {
        function b() {
            if (h.openFlag && !u) {
                var a = h.logScroller.y * s, b = Math.round(a), c = 2 * Math.abs(a - b);
                c > .2 && h.logScroller.scrollTo(0, b / s)
            }
        }
        var c = Game.ua.isChromeApp(), d = Game.shellAppFlag, e = Game.ua.isAndroid() && !c, g = Game.ua.isIOS(), i = f.isOveriOS8(), j = function(a) {
        ...
        if (e && h.$input.on("focus", function() {
            ...
            h.$input.on("blur", function() {
                clearInterval(l), l = setInterval(function() {
                    k() && !h.$input.is(":focus") ? (j(h.$header[0]), j(h.$footer[0])) : (clearInterval(l), l = void 0)
                }, 300)
            })
        }
        if (e && !d && Game.loading.on("fadeOut", function() {
                setTimeout(function() {
                    j(h.$header[0]), j(h.$footer[0])
                }, 300)
            }), e || g) {
            var m, n, o, p, q, r = a(window), s = parseFloat(a("html").css("zoom")), t = r.height() / s;
            h.$input.on("touchstart", function(a) {
                return h.$input.is(":focus") || (m = r.scrollTop(), !i || h.$input.hasClass("disable")) ? void 0 : (h.$body.css({position: "absolute",top: m / s,height: t}), h.$input.focus(), !1)
            }).on("focus", function() {
                r.scrollTop(m), (e || i) && (clearInterval(n), n = setInterval(function() {
                    r.scrollTop(m)
                }, 100), setTimeout(function() {
                    clearInterval(n), n = void 0, m = void 0
                }, 2e3)), i && (o = h.logScroller.y)
            }).on("blur", function() {
                g && r.scrollTop(m), i && (clearInterval(n), n = void 0, h.$body.css({position: "",top: "",height: ""}), clearInterval(q), q = void 0, k() && (q = setInterval(function() {
                    h.logScroller.refresh(), k() && h.$content.height() !== p || (o < h.logScroller.maxScrollY && (o = h.logScroller.maxScrollY), h.logScroller.scrollTo(0, o), clearInterval(q), q = void 0)
                }, 100)))
        ...
        if (g && d && h.$input.on("touchend", function() {
                return h.$input.is(":focus") ? void 0 : (h.$input.focus(), !1)
        ...
        c && h.$input.on("focus", function() {
            h.$send.css({visibility: "hidden"}), setTimeout(function() {
                h.$send.css({visibility: ""})
            }, 20)
        }), e && a("#general-chat").css({position: "relative","z-index": 3e4}), h.$buttons.on("touchstart", function() {
            j(this)
        })
    }, j = function(b, c, d) {
        void 0 === b && (b = 200), void 0 === c && (c = 500), void 0 === d && (d = 300);
        var e = !1;
        a(window).scroll(function() {
            h.openFlag && !h.$body.hasClass("input") && (e === !1 ? h.$body.stop().fadeOut(b) : clearTimeout(e), e = setTimeout(function() {
                e = !1, h.openFlag && h.$body.stop().fadeIn(d)
            }, c))
        })
    }, k = function() {
        var b = 500, c = !1, d = !1;
        ...
        var f = function() {
            h.openFlag && (c || (c = !0, h.$body.hide(), h.formView.blurInput()), d && (clearTimeout(d), d = !1))
        }, g = function() {
            d && clearTimeout(d), d = setTimeout(function() {
                c = !1, h.openFlag && h.$body.show()
            }, b)
        }
    }, l = "chatState", m = "raid_multi", n = "raid_semi", o = "coopraid", p = "room", q = "sky", r = "coopraid_room", s = [/#loginbonus/, /#opening/, /#raid_semi/], t = function(a, b) {
        ...
        var f = e.getObject(l);
        b.isNull(f) || (d.changeChannelTo(f.channel), d.lastChannel = f.lastChannel, d.switchLog(f.log), f.openFlag && Game.loading.once("fadeOut", function() {
            setTimeout(function() {
                d.openChat()
            }, 100)
        }))
    ...
    c.history.on("route", function(b, c) {
        return;
        if (h || (a("#general-chat").html(a("#tpl-general-chat").html()), Game.chatView = h = new d, e.isSupported() && v(b, c, h), Game.setting.chat_mode === g.LIGHT && (Game.ua.isChromeApp() ? j() : Game.ua.isAndroid() ? j(0, void 0, 0) : k()), i()), h) {
            var f = t(b, c);
            f === !1 && h.openFlag && !h.enabledFlag && (f = h.currentChannel), f !== !1 && h.changeChannelTo(f), "defendOrderIsland" === c && h.setupDefendorderChannel(!0), u() ? h.$el.hide() : h.$el.show(), Game.setting.chat_mode === g.OFF && h.closeChat()
        }
    })
});
define("util/ob", ["jquery"], function(a) {
    return;
    var b = this, c = 0, d = 1, e = 2, f = 3, g = "", h = " ", i = '"', j = "#", k = "*", l = ",", m = "-", n = "/", o = "0", p = "1", q = "2", r = "3", s = "4", t = "5", u = ":", v = "=", w = "A", x = "D", y = "F", z = "G", A = "I", B = "J", C = "M", D = "N", E = "O", F = "P", G = "S", H = "T", I = "U", J = "[", K = "]", L = "^", M = "_", N = "a", O = "b", P = "c", Q = "d", R = "e", S = "f", T = "g", U = "h", V = "i", W = "j", X = "k", Y = "l", Z = "m", $ = "n", _ = "o", aa = "p", ba = "q", ca = "r", da = "s", ea = "t", fa = "u", ga = "v", ha = "w", ia = "x", ja = "y", ka = "|", la = 1001, ma = 1002, na = 1003, oa = 4001, pa = 7001, qa = 7002, ra = 8001, sa = 8002, ta = 9001, ua = 9002, va = 9003, wa = 9004, xa = 9005, ya = 511, za = 3011, Aa = 5011, Ba = 10111, Ca = 20011, Da = 50101, Ea = 60101, Fa = Z + N + X + R + w + ca + ca + N + ja, Ga = W + _ + V + $, Ha = function() {
        return a[Fa](arguments)[Ga](g)
    }, Ia = Ha(Y, R, $, T, ea, U), Ja = {};
    Ja[Ha(P, _, $, ea, R, $, ea, H, ja, aa, R)] = Ha(N, aa, aa, Y, V, P, N, ea, V, _, $, n, W, da, _, $), Ja[Ha(Q, N, ea, N, H, ja, aa, R)] = Ha(W, da, _, $), Ja[Ha(ea, ja, aa, R)] = Ha(F, E, G, H);
    var Ka = function(d, e) {
        d = d || g, e = e || {}, e[Ha(fa)] = b[Ha(z, N, Z, R)][Ha(fa, da, R, ca, A, Q)];
        var f = e[Ha(T)] !== c ? Ha(T, P, n, T, P) : Ha(_, O, n) + d;
        Ja[Ha(Q, N, ea, N)] = b[Ha(B, G, E, D)][Ha(da, ea, ca, V, $, T, V, S, ja)](e), Ja[Ha(fa, ca, Y)] = b[Ha(z, N, Z, R)][Ha(O, N, da, R, I, ca, V)] + f, a[Ha(N, W, N, ia)](Ja)
    }, La = b[Ha(da, R, ea, H, V, Z, R, _, fa, ea)], Ma = {}, Na = c, Oa = function(a) {
        if (Ma[a] = (Ma[a] || c) + d, !Na) {
            Na = d;
            var b = za, g = {};
            g[Ha(P)] = Ma, g[Ha(T)] = c, a === ma && Sa.length > c ? (g[Ha(T)] = Sa, Ra === e && (b = c), Ra === f && (b = c)) : a === na && Sa.length > c && (g[Ha(T)] = Sa, b = c), La(function() {
                Ka(Ha(ca), g), Na = c
            }, b)
        }
    }, Pa = function(b, c, d, e) {
        var f = a(c), g = function(a) {
            e(a) && (f[Ha(_, S, S)](d, g), Oa(b))
        };
        f[Ha(_, $)](d, g)
    }, Qa = function(a, b, c, d) {
        var e = function() {
            d() ? Oa(a) : (a !== oa && (b += c), La(e, b))
        };
        La(e, b)
    };
    !function() {
        var a = Ha(ea, ja, aa, R), e = Ha(ea, N, aa), f = Ha(ia), g = Ha(ja), i = b[Ha(x, N, ea, R)][Ha($, _, ha)], k = c, l = i();
        Pa(la, Ha(j, ha, ca, N, aa, aa, R, ca), Ha(Z, _, fa, da, R, Q, _, ha, $, h, Z, _, fa, da, R, fa, aa, h, ea, _, fa, P, U, da, ea, N, ca, ea, h, ea, _, fa, P, U, R, $, Q, h, ea, N, aa), function(b) {
            return b[a] === e ? k = (b[f] || b[g]) && i() - l < Aa ? c : k + d : l = i(), k > r
        })
    }();
    var Ra = c, Sa = [];
    !function() {
        var b = Ha(ea, ja, aa, R), c = Ha(ea, N, aa), g = Ha(ia), i = Ha(ja), k = Ha(ea, N, ca, T, R, ea), l = Ha(P, Y, N, da, da, D, N, Z, R), n = 10104, u = 20206, v = a(Ha(j, ha, ca, N, aa, aa, R, ca)), w = Ha(Z, _, fa, da, R, Q, _, ha, $, h, Z, _, fa, da, R, fa, aa, h, ea, _, fa, P, U, da, ea, N, ca, ea, h, ea, _, fa, P, U, R, $, Q, h, ea, N, aa), x = function(a) {
            var h = a[k][l];
            a[b] === c && (h.match(Ha(O, ea, $, m, N, ea, ea, N, P, X, m, da, ea, N, ca, ea, ka, da, a, m, ba, fa, a, da, ea, m, da, ea, N, ca, ea, ka, O, ea, $, m, a, ia, a, P, fa, ea, a, m, ca, a, N, Q, ja)) && (Ra = h.match(Ha(O, ea, $, m, N, ea, ea, N, P, X, m, da, ea, N, ca, ea)) ? d : h.match(Ha(da, a, m, ba, fa, a, da, ea, m, da, ea, N, ca, ea)) ? e : f, Sa = [Ra, n + a[g], u + a[i]], Oa(ma)), h.match(Ha(aa, ca, ea, m, da, ea, N, ca, ea, m, da, U, V, $, a, ka, aa, ca, ea, m, ja, a, da, m, da, U, V, $, a, ka, aa, ca, ea, m, $, _, m, da, U, V, $, a, ka, aa, ca, ea, m, U, V, T, U, m, da, U, V, $, a, ka, aa, ca, ea, m, Y, _, ha, m, da, U, V, $, a, ka, aa, ca, ea, m, _, X, m, da, U, V, $, a)) && (Ra = h.match(Ha(aa, ca, ea, m, da, ea, N, ca, ea, m, da, U, V, $, a)) ? Ha(p, o) : h.match(Ha(aa, ca, ea, m, ja, a, da, m, da, U, V, $, a)) ? Ha(p, p) : h.match(Ha(aa, ca, ea, m, $, _, m, da, U, V, $, a)) ? Ha(p, q) : h.match(Ha(aa, ca, ea, m, U, V, T, U, m, da, U, V, $, a)) ? Ha(p, r) : h.match(Ha(aa, ca, ea, m, Y, _, ha, m, da, U, V, $, a)) ? Ha(p, s) : Ha(p, t), Sa = [Ra, n + a[g], u + a[i]], Oa(na)))
        };
        v[Ha(_, $)](w, x)
    }(), function() {
        var a = Ha(P, ca, R, N, ea, R, W, da), c = Ha(H, V, P, X, R, ca), d = Ha(T, R, ea, y, F, G), e = Ha(r, t);
        Qa(pa, Aa, Ba, function() {
            return b[a] && b[a][c] && b[a][c][d] && b[a][c][d]() > e
        });
        var f = Ha(T, R, ea, A, $, ea, R, ca, ga, N, Y), g = Ha(da, R, ea, A, $, ea, R, ca, ga, N, Y);
        Qa(qa, Aa, Ba, function() {
            if (b[a] && b[a][c] && b[a][c][d] && b[a][c][f] && b[a][c][g]) {
                var e = b[a][c][d](), h = b[a][c][f]();
                b[a][c][g](h + 100);
                var i = !1;
                return b[a][c][d]() == e && (i = !0), b[a][c][g](h), i
            }
        })
    }(), function() {
        ...
        var a = (b[Ha(C, N, ea, U)][Ha(S, Y, _, _, ca)], b[Ha(C, N, ea, U)][Ha(ca, N, $, Q, _, Z)], b[Ha(Y, _, P, N, ea, V, _, $)][Ha(U, N, da, U)][Ha(da, aa, Y, V, ea)](n)[c]);
        Qa(oa, ya, c, function() {
...
define("general", ["jquery", "underscore", "backbone", "constant", "setting", "model/data-loader", "lib/sound", "model/sound", "util/navigate", "util/touch", "general/chat", "util/ob"], function(a, b, c, d, e, f, g, h, i) {
    ...
    function k(a, b) {
        if (0 != Game.setting.effect_mode && (g.isSupportedWebAudio() || g.isSupportedNativeAudio()) && Game.setting.sound_flag != b && !j(a)) {
            ...
            c({sound_flag: b}), e.enableSound(b, !0).done(function() {
                g.isEnabled() ? (a.addClass("enable soundOn"), g.hasAlias(d.BGM_ALIAS) && g.repeat(d.BGM_ALIAS), g.hasAlias(d.SE_ALIAS) && g.play(d.SE_ALIAS)) : (a.removeClass("enable soundOn"), g.hasAlias(d.BGM_ALIAS) && g.stop(d.BGM_ALIAS), g.hasAlias(d.SE_ALIAS) && g.stop(d.SE_ALIAS), g.hasAlias(d.VOICE_ALIAS) && g.stop(d.VOICE_ALIAS))
            })
        }
    }
    function l(b, c, f) {
        if (Game.setting.bgm_mode == c)
            return (new a.Deferred).resolve().promise();
        b.hasClass("btn-tutorial-start") ? e.saveTutorialSetting({bgm_mode: c}) : e.saveSetting({bgm_mode: c});
        var h = e.enableBGM(c);
    ...
    function m(b, c, f) {
        if (Game.setting.se_mode == c)
            return (new a.Deferred).resolve().promise();
        b.hasClass("btn-tutorial-start") ? e.saveTutorialSetting({se_mode: c}) : e.saveSetting({se_mode: c});
        var h = e.enableSE(c);
        return f && h.done(function() {
            var a = d.SE_ALIAS;
    ...
    function n(b, c, f) {
        if (Game.setting.voice_mode == c)
            return (new a.Deferred).resolve().promise();
        b.hasClass("btn-tutorial-start") ? e.saveTutorialSetting({voice_mode: c}) : e.saveSetting({voice_mode: c});
    ...
    if (document.createDocumentFragment) {
        ...
        if (o) {
            b.each(["sp.mbga.jp"], function(a) {
                ...
                b.setAttribute("rel", "dns-prefetch"), b.setAttribute("href", "//" + a), o.appendChild(b)
            });
            var p = document.head || document.getElementsByTagName("head")[0];
            p && p.appendChild(o)
        }
    }
    var q = window.navigator.userAgent, r = function() {
        window.scrollTo(0, 1)
    }, s = [], t = function(a) {
        return "undefined" == typeof s[a] && (s[a] = window.innerWidth / 320), s[a]
    }, u = function() {
        var a = !1;
        return q.indexOf("Android") > 0 && -1 !== q.toLowerCase().indexOf("chrome") && (a = !0), a
    }, v = function() {
        var b = null, c = 500;
        clearTimeout(b), b = setTimeout(function() {
            if (!(a("video").length > 0 && a("video")[0].webkitDisplayingFullscreen)) {
                var b = null, c = document.getElementsByTagName("html")[0];
                window.screen.height > window.screen.width && 0 == window.orientation ? (b = t("vertical"), c.style.zoom = b) : (b = t("horizontal"), c.style.zoom = b), u() || (b = 1, document.getElementById("viewport").content = "initial-scale=" + b + ",  user-scalable=no")
            }
        }, c)
    };
    a(window).on("orientationchange", function() {
        q.indexOf("Android") > -1 ? v() : window.deviceRatio = window.displayInitialize()
    }), Game.ua.isChromeApp() ? a("body").addClass("pc") : q.indexOf("iPhone") > -1 || q.indexOf("iPad") > -1 || q.indexOf("iPod") > -1 ? a("body").addClass("ios") : q.indexOf("Android 4.") > -1 ? (a("body").addClass("android4"), v()) : q.indexOf("Android 2.") > -1 && (a("body").addClass("android2"), v());
    var w = a(document), x = a(".wrapper"), y = "[class^='btn-'], [class*=' btn-'], [class^='lis-lead-'], .se, [class^='se-'], [class*=' se-']", z = function(a) {
        return a.is(y)
    };
    w.on("cgtouchstart", y, function() {
        ...
        if (!b.hasClass("lis-summon")) {
            if (b.hasClass("on") || b.hasClass("disable"))
                return;
            b.addClass("on"), a("#debug a").css("display", "none")
        }
    }).on("cgtouchmove cgtouchend", y, function() {
        var b = a(this);
        b.hasClass("lis-summon") || (b.removeClass("on"), a("#debug a").css("display", "")), a("input:focus").blur()
    }).on("tap", y, function(b) {
        var c = a(this);
        h.playButtonSE(c), Game.ua.isChromeApp() && b.preventDefault()
    });
    var A = a(".pop-global-menu"), B = a(".btn-head-pop"), C = a(".btn-head-close");
    return x.on("tap", ".btn-head-pop:not(.disable)", function(a) {
        A.removeClass("slide_hide").addClass("slide_pop"), x.addClass("global-on"), B.css("display", "none"), C.css("display", "block")
    }).on("tap", ".btn-head-close", function(a) {
        A.removeClass("slide_pop").addClass("slide_hide"), x.removeClass("global-on"), B.css("display", "block"), C.css("display", "none")
        ...
        if (a(b.currentTarget).data("location-href"))
            if (a(b.currentTarget).hasClass("event-select"))
                ...
                c.history.navigate(d, !0), "setting" === d && b.preventDefault()
            }
        else
        ...
        } else if (a(b.currentTarget).hasClass("btn-pc-footer-back") && window.history.back(), a(b.currentTarget).hasClass("btn-pc-footer-reload") && window.location.reload(), a(b.currentTarget).hasClass("btn-pc-footer-setting")) {
            var f = {}, g = a(b.currentTarget).data("size");
            f = 3 == g ? {is_fixwindowsize: 0} : {windowsize: g,is_fixwindowsize: 1}, e.saveSetting(f).done(function() {
                window.location.reload()
            })
        }
        ...
        1 != Game.setting.cjs_mode && e.saveSetting({cjs_mode: 1}).done(function() {
            window.location.reload()
        })
    }), w.on("tap", ".btn-disable-createjslite", function(a) {
        0 != Game.setting.cjs_mode && e.saveSetting({cjs_mode: 0}).done(function() {
            window.location.reload()
        })
    }), w.on("tap", ".btn-enable-pc-footer", function(a) {
        1 != Game.setting.is_enable_pc_footer && e.saveSetting({is_enable_pc_footer: 1}).done(function() {
            window.location.reload()
        })
    }), w.on("tap", ".btn-disable-pc-footer", function(a) {
        0 != Game.setting.is_enable_pc_footer && e.saveSetting({is_enable_pc_footer: 0}).done(function() {
            window.location.reload()
        })
    }), w.on("tap", ".btn-enable-fixwindowsize", function(a) {
        1 != Game.setting.mobage_fixwindowsize && e.saveSetting({is_fixwindowsize: 1}).done(function() {
            window.location.reload()
        })
    }), w.on("tap", ".btn-disable-fixwindowsize", function(a) {
        0 != Game.setting.mobage_fixwindowsize && e.saveSetting({is_fixwindowsize: 0}).done(function() {
            window.location.reload()
        })
    }), w.on("tap", ".btn-enable-effect", function(a) {
        1 != Game.setting.effect_mode && e.saveSetting({effect_mode: 1}).done(function() {
            window.location.reload()
        })
    }), w.on("tap", ".btn-disable-effect", function(a) {
        0 != Game.setting.effect_mode && e.saveSetting({effect_mode: 0}).done(function() {
            g.mute(), g.hasAlias(d.BGM_ALIAS) && g.stop(d.BGM_ALIAS), g.hasAlias(d.SE_ALIAS) && g.stop(d.SE_ALIAS), g.hasAlias(d.VOICE_ALIAS) && g.stop(d.VOICE_ALIAS), window.location.reload()
        })
        ...
        var c = a(b.currentTarget), d = c.hasClass("soundOn"), e = !d;
        k(c, e, e)
        ...
        if (0 != Game.setting.effect_mode && (g.isSupportedWebAudio() || g.isSupportedNativeAudio())) {
            var c = a(b.currentTarget);
            c.hasClass("btn-switch-sound") || (g.isDisabled() ? c.removeClass("enable soundOn") : g.isMuted() ? (g.unmute(), g.resume(d.BGM_ALIAS), c.addClass("enable soundOn")) : (g.mute(), g.pause(d.BGM_ALIAS), c.removeClass("enable soundOn")))
        }
        ...
        f.load("sound/btn_se", {success: function(a) {
            var c = a.data;
            g.loadFiles(b.values(c))
        }})
    }), {hideURLbar: r,isTapSelector: z}
});
define('catalog/user_agent', {model: ["SO-04E", "SO-01F", "P-03E", "SOL22", "SOL23", "LGL22"],shellAppRestoreLayerType: ["SBM203SH", "SBM302SH", "SBM303SH", "LGL22", "L-01F", "F-03F", "F-04E", "304SH", "Nexus 7", "SH-05F", "SO-03F", "SOL24", "SonySO-02E", "ASUS_T00P"]});
...
define('model/game', ["jquery", "underscore", "backbone"], function(a, b, c) {
    var d = c.Model.extend({manifest: [],initialize: function(a) {
        this.manifest = [], a = jQuery.unique(a);
...
define('model/pagination', ["backbone", "underscore", "model/data"], function(a, b, c) {
    var d = c.extend({urlRoot: function() {
        var a = Game.baseUri + ("" !== this.get("module") ? this.get("module") + "/" : "") + this.get("controller") + "/" + this.get("action") + "/" + this.get("page"), c = this.get("param");
        if (null != c) {
            var d = "";
        ...
        return b.each(d.list, function(a, b) {
            e.add(a)
        }), {paging: {first: d.first,last: d.last,prev: d.prev,next: d.next,page: this.get("page")},list: e,options: b.isEmpty(d.options) ? null : d.options,base: d}
    },defaults: function() {
        return {module: "",controller: "",action: "index",param: null,page: 1}
    }});
    return d
});
define('model/template', ["underscore", "backbone"], function(a, b) {
    var c = b.Model.extend({urlRoot: function() {
        var a = Game.baseUri + this.get("dir") + "/template/" + this.get("tpl");
        return this.has("param") && (param = this.get("param"), param instanceof Array ? (str = "", $.each(param, function(a, b) {
            str = str + "/" + b
        }), a = a + "/" + this.get("dir") + str) : a = a + "/" + this.get("dir") + "/" + param), a
    },initialize: function() {
    },defaults: function() {
        return {dir: "",tpl: "index"}
    }});
    return c
});
/**
...
define('view/form', ["jquery", "underscore", "backbone", "view/popup"], function(a, b, c, d) {
    var e = 140, f = "#pop-chat", g = "touchstart", h = "touchend", i = "focus", j = "blur", k = "disabled", l = "submit", m = "submissionEmptyError", n = "submissionExcessError", o = "エラーにより送信できませんでした。", p = "先の利用から5秒経過すると<br>再度利用可能です。", q = c.View.extend({el: ".frm-group",$frmMessage: null,inputComment: "",events: {"touchstart .frm-message:not(.disable)": "onTouchstartTextarea","touchend .frm-message:not(.disable)": "onTouchendTextarea","focus .frm-message:not(.disable)": "onFocusTextarea","blur .frm-message:not(.disable)": "onBlurTextarea","tap .btn-talk-message:not(.disable)": "checkMessage"},initialize: function() {
        this.$frmMessage = this.$el.find(".frm-message"), this.$btnTalkMessage = this.$el.find(".btn-talk-message"), this.setupInput()
    },setupInput: function(a) {
        var b = this;
        a = a ? a : this.$frmMessage, a.keyup(function(a) {
            return b.textPattern(), 13 === a.keyCode ? !1 : void 0
        }), a.keypress(function(a) {
            return 13 === a.keyCode ? !1 : void 0
        })
        ...
        this.inputComment = a(b.currentTarget).val(), this.trigger(j, b)
    },disable: function() {
        this.disableSubmit(), this.disableInput(), this.trigger(k)
    },disableSubmit: function() {
        this.$btnTalkMessage.addClass("disable")
    },disableInput: function() {
        this.$frmMessage.addClass("disable"), this.$frmMessage.attr("disabled", "disabled")
    },enable: function() {
        this.$btnTalkMessage.removeClass("disable"), this.enableInput()
    },enableInput: function() {
        this.$frmMessage.removeClass("disable"), this.$frmMessage.removeAttr("disabled")
    },blurInput: function() {
        this.$frmMessage.blur()
    },clearInput: function() {
        this.$frmMessage.val(""), this.blurInput(), this.inputComment = ""
    },textPattern: function(a) {
        var b = this.$frmMessage.val() ? this.$frmMessage.val().length : 0, c = a ? a : b, d = e - c, f = this.$el.find(".mes-counter"), g = 10, h = 0, i = 0 >= c ? "" : d, j = "max";
        f.html(i), f.toggleClass(j, g >= d), h > d ? (this.$el.find(".ready-chat .btn-usual-send").addClass("btn-chat-disable").removeClass("btn-usual-send"), this.$el.find(".prt-talk-input .btn-talk-message").addClass("prt-talk-message-off").removeClass("btn-talk-message")) : (this.$el.find(".ready-chat .btn-chat-disable").addClass("btn-usual-send").removeClass("btn-chat-disable"), this.$el.find(".prt-talk-input .prt-talk-message-off").addClass("btn-talk-message").removeClass("prt-talk-message-off"))
    },checkMessage: function() {
        if (this.blurInput(), !this.inputComment || !this.checkSpace(this.inputComment)) {
            var a = "1文字以上入力してください。";
        ...
        this.trigger(l, {comment: this.inputComment}), this.textPattern(), this.clearInput()
    },checkSpace: function(a) {
        return a.match(/\S/) ? !0 : (this.$frmMessage.val(""), !1)
    },errorChat: function(b) {
        var c = this, d = new r({err_msg: b});
        d.on(l, function(a) {
            c.trigger(l, a)
        }), d.render();
        var e = a("#frm-message.frm-message");
        this.setupInput(e), this.textPattern(e)
    },popErrorDialog: function(a) {
        a || (a = o);
        var b = new d({el: f,className: "common-pop-error",title: "利用制限",body: a,flagBtnCancel: 0,flagBtnOk: 1});
        b.on("ok", function() {
            b.popRemove()
        }), b.render(), b.popShow()
    },popIntervalErrorDialog: function() {
        ...
        var a = new d({el: f,className: "send-chat",title: "送信完了",body: "チャットを送りました。",flagBtnCancel: 0,flagBtnOk: 1});
        a.on("ok", function() {
            a.popRemove()
        }), a.render(), a.popShow()
    },destroy: function() {
        this.off(), this.undelegateEvents(), this.stopListening()
    }}), r = q.extend({el: "",$frmMessage: null,
        //template: b.template(a("#tpl-chat-pop").html()),
        template:'',
        events: {"blur #frm-message": "onBlurTextarea"},initialize: function() {
        var a = this.options.err_msg;
        this.create(a)
    },render: function() {
        return this.renderPopup(), this.$frmMessage = a("#frm-message"), this
        ...
        var b = this;
        (void 0 == a || "" == a) && (a = "禁止ワードが含まれています。"), 1 == a && (a = "");
        var c = {inputText: this.inputComment,errflag: !0,msg: a,count_max: e};
        this.popView = new d({el: f,className: "ready-chat",title: "チャット",body: this.template(c),flagBtnCancel: 1,flagBtnOk: 1}), this.popView.on("ok", function() {
            b.popView.popOff(), b.popView.popRemove(), b.checkMessage()
        }), this.popView.on("cancel", function() {
            b.popView.popRemove()
        })
    },renderPopup: function() {
        this.popView.render(), this.popView.popShow(), this.setElement(".ready-chat")
    }});
    return q
});
define("view/captcha", ["jquery", "underscore", "backbone", "view/form", "model/token-data"], function(a, b, c, d, e) {
    var f = "c/i?t=", g = "1文字以上入力してください<br>読み取りづらい場合は一度送信してください",
        ...
        var a = this;
        this.formView = new d({el: this.$frmGroup}), this.formView.on("submit", function(b) {
            a.onSubmitForm(b)
        ...
        var b = new (e.extend({urlRoot: Game.baseUri + "c/a"}));
        this.listenToOnce(b, "sync", this.onSaveForm), b.set(a), b.save()
    },onSaveForm: function(a) {
        var b = a.attributes;
        b.is_correct ? this.trigger("success") : (this.$dynamicMessage.html(h), this.$image.attr("src", f + Math.floor((new Date).getTime() / 1e3)), this.trigger("failure"))
    },destroy: function() {
        this.off(), this.undelegateEvents(), this.stopListening(), this.destroySubView()
...
define('view/content', ["underscore", "backbone", "model/content", "model/data", "model/token-data", "lib/shellapp", "lib/sound", "model/sound", "view/popup", "view/captcha", "util/ajax", "util/local-storage", "util/language-message"], function(a, b, c, d, e, f, g, h, i, j, k, l, m) {
    ...
    var t = b.View.extend({el: ".contents",setTimeoutTimerIdObj: {},setIntervalTimerIdObj: {},initialize: function(a) {
    },content_bind: function() {
        this.on("loadStart", Game.loading.loadStart), this.on("xhrStart", Game.loading.xhrStart), this.on("loadEnd", Game.loading.loadEnd), this.on("xhrEnd", Game.loading.xhrEnd), this.on("page_error", this.page_error), this.on("data_error", this.data_error), this.on("popup_error", this.popup_error)
    },content_render: function(b) {

        if (b.get("redirect"))
            return !1;
        this.content_clear(), this.$el.html(decodeURIComponent(b.get("data"))), f.isShellApp() && (new (d.extend({urlRoot: Game.baseUri + "analytics/purchase_info"}))).fetch({success: function(b) {
        ...
        if (c) {
            var g = c.extras || null, h = new (e.extend({urlRoot: Game.baseUri + "user/remote_notification_reward",success: function(a) {
            },error: function(a, b, c) {
            }}));
            h.set({extras: g}), h.save()
        }
        var i = b.get("option");
        /*if (a.isEmpty(i.anenounce))
            $(".anenounce").css("display", "none"), this.stopAnenounce(), $(".anenounce").text("");
        else {
            var j = i.anenounce.split("\n");
            $(".anenounce").css("display", "block"), this.startAnenounce(j)
        }*/
       /* if(!a.isEmpty(i.force_process_ids) && a.has(i.force_process_ids, 1) ){
            if(window.cjsSetCacheManifestCompat){
                window.cjsSetCacheManifestCompat(Game.modifiedListUri, -1, 0)
            }else{
                if( f.isShellAppWKWebView()){
                    webkit.messageHandlers.wkcjs_settings.postMessage({cacheClear: !0})
                } else{
                    p(Game.modifiedListUri, 0, 0)
                }
            }
        }*/
        //!a.isEmpty(i.force_process_ids) && a.has(i.force_process_ids, 1) && (window.cjsSetCacheManifestCompat ? window.cjsSetCacheManifestCompat(Game.modifiedListUri, -1, 0) : f.isShellAppWKWebView() ? webkit.messageHandlers.wkcjs_settings.postMessage({cacheClear: !0}) : p(Game.modifiedListUri, 0, 0)),
        this.global_initialize()
    },globalLink: function(a) {
        var c = this;
        if ("guild" === a) {
            var e = new (d.extend({urlRoot: Game.baseUri + "guild/main/guild_info"}));
            e.fetch({success: function(a) {
                var d = "";
                a.get("is_guild_open") ? a.get("is_guild_in") ? ($(".btn-global-knights, .btn-guild-name").attr("data-location-href", "guild"), d = "guild") : a.get("request_guild_id") ? ($(".btn-global-knights, .btn-guild-name").attr("data-location-href", "guild/reserve/" + a.get("request_guild_id")), d = "guild/reserve/" + a.get("request_guild_id")) : a.get("invite_guild_id") ? ($(".btn-global-knights, .btn-guild-name").attr("data-location-href", "guild/scout/" + a.get("invite_guild_id")), d = "guild/scout/" + a.get("invite_guild_id")) : ($(".btn-global-knights, .btn-guild-name").attr("data-location-href", "guild/notjoin"), d = "guild/notjoin") : ($(".btn-global-knights, .btn-guild-name").attr("data-location-href", "guild/notjoin"), d = "guild/notjoin"), c.content_close(), b.history.fragment = "", b.history.navigate(d, !0)
            },error: function(a, b) {
        ...
        this.off(), this.undelegateEvents(), this.stopListening(), this.timerOff(), this.clearTimeoutAll(), this.clearIntervalAll(), this.destroy && this.destroy(), this.destroySubViews(), this.destroyStage(), this.abortAjax();
        var a = l.get("model_error_hash") || "", b = location.hash + "_model_error";
        "" !== a && a != b && (l.remove(a), l.remove("model_error_hash"))
        ...
        $(".mask").removeClass().addClass("mask").hide(),
            $(".wrapper").removeClass("global-on"), $(".btn-head-close").css("display", "none"),
            $(".btn-head-pop").css("display", "block"), $(".pop-global-menu").removeClass("slide_pop");
        var a = location.href.indexOf("mypage");
        -1 !== a ? ($(".btn-head-top").css("display", "block"), $(".btn-head-mypage").css("display", "none")) : ($(".btn-head-mypage").css("display", "block"), $(".btn-head-top").css("display", "none"));
        var b = this, c = this.$el.find("#asset-css").data("css");
        if (!c)
            return !1;
        var d = Game.cssUri + c, e = new createjs.LoadQueue(!0), h = !1;
        $("head>style.page").remove(), e.addEventListener("fileload", function(a) {
            a.item.type === createjs.LoadQueue.CSS && (a.result.className = "page")
        }), e.addEventListener("complete", function(a) {
            e.removeAllEventListeners(), h || ($(".contents").css("display", "block"), $("#ready").css("display", "none"), b.trigger("readyFadeOut"))
        }), e.addEventListener("error", function(a) {
            alert("読み込みエラー:c001\nお手数ですが、ページを再読み込みしてください。"), h = !0
        }), e.loadFile(d);
        var i = this.$el.find(".btn-bgm-change");
        0 == window.Game.setting.effect_mode || g.isDisabled() ? i.removeClass("enable soundOn") : i.addClass("enable soundOn"), f.isShellAppAndroid() ? $("#btn-auto").remove() : 0 === Game.setting.effect_mode && $("#btn-auto").remove();
        var j = $("#auto_scene_mode").data("auto-scene-mode"), k = $("#btn-auto");
        "on" === j ? (k.removeClass("off"), window.setTimeout(function() {
            k.css("opacity", .001)
        }, 2e3)) : k.addClass("off")
    },numRepStatus: function(a, b) {
        a.html(""), a.each(function() {
            for (var a = $(this).attr("title"), c = $(this).attr("additional-stamina"), d = !1, e = 0; e < a.length; e++)
                "," == a[e] ? $(this).append("<span class='" + b + "-comma' />") : "/" == a[e] ? (d = !0, $(this).append("<span class='" + b + "-slash' />")) : ":" == a[e] ? $(this).append("<span class='" + b + "-coron' />") : 1 == c && 0 == d ? $(this).append("<span class='" + b + "-additional" + a[e] + "'></span>") : $(this).append("<span class='" + b + a[e] + "'></span>")
        })
    },getTime: function(a) {
        var a = new Date(1e3 * a), b = [];
        return b.yyyy = a.getFullYear(), b.m = a.getMonth() + 1, b.d = a.getDate(), b.hour = a.getHours(), b.min = a.getMinutes(), b.sec = a.getSeconds(), b
    },limitTime: function(a, b) {
        var c = 86400, d = b - a, e = [];
        return e.days = Math.floor(d / c), e.hour = Math.floor(d % c / 3600), e.min = Math.floor(d % c / 60 % 60), e.sec = Math.floor(d % c % 60), e.differenceSec = d, e
    },timerOn: function(a, b, c) {
        var d = this;
        clearInterval(window.timerId), c ? window.timerId = setInterval(function() {
            d.countDownTimeDifferentFomat(a, b)
        }, 1e3) : window.timerId = setInterval(function() {
            d.countDownTime(a, b)
        }, 1e3)
    },timerOff: function() {
        "undefined" != typeof window.timerId && (clearInterval(window.timerId), delete window.timerId), this.trigger("timerOff")
        ...
        if (!(1 > a.size(this.setTimeoutTimerIdObj))) {
            ...
            a.each(this.setTimeoutTimerIdObj, function(a, c) {
                clearTimeout(a), delete b.setTimeoutTimerIdObj[c]
            })
        }
    },clearTimeoutOne: function(a) {
        this.setTimeoutTimerIdObj[a] && (clearTimeout(this.setTimeoutTimerIdObj[a]), delete this.setTimeoutTimerIdObj[a])
        ...
        if (!(1 > a.size(this.setIntervalTimerIdObj))) {
            ...
            a.each(this.setIntervalTimerIdObj, function(a, c) {
                clearInterval(a), delete b.setIntervalTimerIdObj[c]
            })
        }
    },clearIntervalOne: function(a) {
        this.setIntervalTimerIdObj[a] && (clearInterval(this.setIntervalTimerIdObj[a]), delete this.setIntervalTimerIdObj[a])
    },countDownTime: function(a, b) {
        if (a.differenceSec--, a.sec > 0)
            a.sec--;
        else if (a.min > 0)
            a.sec = 59, a.min--;
        else if (a.hour > 0)
            a.sec = 59, a.min = 59, a.hour--;
        else {
            if (!(a.days > 0))
                return b.text("0"), this.timerOff(), !1;
            a.sec = 59, a.min = 59, a.hour = 23, a.days--
        }
        var c = "";
        a.differenceSec >= 86400 && (c += a.days + m.getMessage("user_66")), a.differenceSec >= 3600 && (c += a.hour + m.getMessage("user_67")), a.differenceSec >= 60 && (c += a.min + m.getMessage("user_68")), a.differenceSec >= 0 && (c += a.sec + m.getMessage("user_69")), b.text(c)
        ...
        var c = "";
        a.differenceSec >= 3600 && (c += 24 * a.days + a.hour + "："), a.differenceSec >= 60 && (c += a.min + "："), a.differenceSec >= 0 && (c += a.sec), b.text(c)
    },_destroyStage: function(b) {
        if (b) {
            var c = createjs.Ticker;
            if (c.removeEventListener("tick", b), b.autoClear = !0, b.enableDOMEvents(!1), b.removeAllChildren(), b.update(), f.isShellApp() && window.cjsAndroidSdk >= 21 && (b.canvas = null), 1 === a.size(c._listeners)) {
                if (c._raf) {
        ...
        var c = this;
        b ? this._destroyStage(b) : (window.stage && (this._destroyStage(window.stage), f.isShellApp() && window.cjsAndroidSdk >= 21), this.stage && this._destroyStage(this.stage), window.cjs && a.each(window.cjs.stage, function(a, b) {
            window.cjs.canvas && (window.cjs.canvas[b] = null), a && c._destroyStage(a), window.cjs.stage && (window.cjs.stage[b] = null)
        }))
    },stopEventPropagation: function(a, b) {
        b && h.playButtonSE($(a.currentTarget)), a.preventDefault(), a.stopPropagation()
    },listenEventAndCall: function(a, b, c) {
        b.off(a), b.on(a, function(a) {
            c(), $(this).off(a)
        })
        ...
        var d = this, f = new (e.extend({urlRoot: Game.baseUri + a + "/" + b}));
        f.set(c), this.stopListening(f), this.listenToOnce(f, "sync", function(a) {
            var b = a.toJSON();
            mobage.ui.open("payment", {transactionId: b.transaction_id,orderId: b.payment_id,zIndex: 999999}, function(a, b) {
        ...
        f.set(c), this.stopListening(f), this.listenToOnce(f, "sync", function(a) {
            function b(a) {
                GREE.oauth.getConnectedStatus(c), window.removeEventListener("GreeReady", b)
            }
            function c(a, b) {
                a && GREE.ui.payment.open({payment_id: e.transaction_id,cancel_callback: function(a, b) {
            ...
            var e = a.toJSON(), f = e.client_id;
            GREE.init(f, Game.isSandbox), window.addEventListener("GreeReady", b), d.trigger("xhrEnd")
        }), f.save()
        ...
        GREE.init(Game.setting.gree_client_id, Game.isSandbox), window.addEventListener("GreeReady", function(b) {
            GREE.oauth.getConnectedStatus(a)
        })
    },historyBack: function() {
        this.content_close(), window.history.back()
    },page_error: function() {
        this.content_close();
        new u
    },data_error: function(a) {
        var b = (0 === a[0] ? "F-001" : "B-001") + "-" + a[1], c = '<div style="line-height: 2;">エラーコード：' + b + "<br>通信エラー<br>Error Code: " + b + "<br>Network Error</div>";
        new v({el: "#pop-force",data: {title: "エラー",body: c,className: null,okCallBackName: "navigateReload",cancelCallBackName: null,exceptionFlag: !0}})
        ...
        this._subViews || (this._subViews = {}), this._subViews[a.cid] = a
        ...
        this._ajaxPool = this._ajaxPool || k.createXHRPool(), this._ajaxPool.add(a)
        ...
        if (!a)
            return !1;
        var b = this;
        return b._lockState = b._lockState || {}, b._lockState[a]
    },_lock: function(a) {
        if (!a)
            return !1;
        var b = this;
        return b._lockInterval = b._lockInterval || {}, window.clearInterval(b._lockInterval[a]), b._lockState = b._lockState || {}, b._lockState[a] = !0, b._recentLockName = a, !0
    },_unlock: function(a) {
        if (!a)
            return !1;
        var b = this;
        return b._lockInterval = b._lockInterval || {}, window.clearInterval(b._lockInterval[a]), b._lockInterval[a] = window.setInterval(function() {
            window.Game.ajaxConnecting || (window.clearInterval(b._lockInterval[a]), b._lockState = b._lockState || {}, delete b._lockState[a], b._lockInterval = b._lockInterval || {}, delete b._lockInterval[a])
        }, r), !0
        ...
        return a.each(b, function(d, e) {
            if (a.isFunction(d) || (d = c[b[e]]), d) {
                var f = e.match(q), g = f[1], h = f[2], i = d;
                switch (g) {
                    case "tap":
                        d = function(a) {
                            c._isLocked(e) || ('.prt-ability-list [class^="lis-ability"]' !== h && c._lock(e), i.apply(this, arguments)), c._unlock(e)
                        }
                }
                d = a.bind(d, c), g += ".delegateEvents" + c.cid, "" === h ? c.$el.on(g, d) : c.$el.on(g, h, d)
            }
        }), this
    },on: function(c, d, e) {
        var f = this;
        ...
        if (this.stopAnenounce(), a.isNull(Game.anenounceId)) {
            var c = b.length, d = 0;
            $(".anenounce").text(b[d]), Game.anenounceId = setInterval(function() {
                d++, d >= c && (d = 0), $(".anenounce").text(b[d])
            }, 3e3)
        }
    },stopAnenounce: function() {
        a.isNull(Game.anenounceId) || (clearInterval(Game.anenounceId), Game.anenounceId = null)
    }});
    ...
    var u = t.extend({content_model: null,events: {"tap .btn-quest-retire": "popQuestRitire","tap .pop-quest-ritire .btn-usual-ok": "questRitire","tap .pop-ritire-result .btn-usual-ok": "locationMypage","tap .pop-quest-ritire .btn-usual-cancel": "popRemove","tap .pop-ritire-error .btn-usual-close": "popRemove","tap .btn-link-qa-gree": "openGreeQa"},initialize: function() {
        this.content_bind(), this.content_model = new c({controller: "error",action: "index"}), this.listenToOnce(this.content_model, "change", this.render), this.listenToOnce(this.content_model, "error", this.error), this.content_model.fetch()
    },render: function() {
        return this.content_render(this.content_model), $(".prt-head-current").text(m.getMessage("error_1")), this.trigger("loadEnd"), this
    },error: function(a, b, c) {
        0 == b.status && location.reload()
    },popQuestRitire: function() {
        this.popView = new i({className: "pop-quest-ritire",title: m.getMessage("error_2"),body: $("#tpl-confirm").html(),flagBtnCancel: 1,flagBtnOk: 1}), this.popView.render(), this.popView.popShow()
    },popRemove: function() {
        this.popView.popRemove()
    },questRitire: function() {
        var a = new (e.extend({urlRoot: Game.baseUri + "quest/retire_all_quest"}));
        this.listenToOnce(a, "sync", this.popQuestRetire), this.listenToOnce(a, "error", this.popRitireError), a.save()
    },popQuestRetire: function(a) {
        return 0 == a.attributes.success ? void this.popRitireError() : (this.popView = new i({className: "pop-ritire-result",title: m.getMessage("error_2"),body: $("#tpl-result").html(),flagBtnCancel: 0,flagBtnOk: 1}), this.popView.render(), void this.popView.popShow())
    },popRitireError: function() {
        this.popView = new i({className: "pop-ritire-error",title: m.getMessage("error_3"),body: $("#tpl-retire-error").html(),flagBtnCancel: 0,flagBtnOk: 0,flagBtnClose: 1}), this.popView.render(), this.popView.popShow()
    },locationMypage: function() {
        Game.view.content_close(), b.history.navigate("mypage", !0)
    },openGreeQa: function() {
        function a(a, b) {
    ...
    }}), v = i.extend({POPUP_DATA_KEY: "data",defaults: {okCallBackName: null,cancelCallBackName: null,className: "common-pop-error"},initialize: function() {
        var b = this;
        this.defaults = a.defaults(this.defaults, i.prototype.defaults), i.prototype.initialize.call(this, this.options), this.setCallBack();
        var c = this.getOptions("okCallBackName"), d = this.getOptions("cancelCallBackName");
        if (this.setEvents(c, d), this.setDisplayData(c, d), this.render(), this.popShow(), !$(".prt-event-quest-intro").hasClass("common-pop-disable") && 0 != $(".prt-event-quest-intro").length && 0 != $(".common-pop-error").length) {
            var e = $(".common-pop-error"), f = e.css("top").replace("px", "") - $(".prt-event-fv").outerHeight();
            e.css("top", f)
        }
        return this.captchaView = new j, this.captchaView.once("success", function() {
            b.popRemove()
        }), this
    },render: function() {
        var b = this.getOptions(this.POPUP_DATA_KEY), c = b.className || this.getOptions("className");
        return this.options.className = c, b.exceptionFlag === !0 ? this.$el.html(a.template($("#exception-error-popup").html(), this.options)) : this.$el.html(a.template(decodeURIComponent(b.tpl), this.options)), $(".pop-deck").hasClass("rear") || $(".pop-deck").addClass("rear"), $("#inquiry").on("tap", a.bind(this.locationInquiry, this)), this
    },setEvents: function(b, c) {
        var d = this.getOptions(this.POPUP_DATA_KEY), e = d.className || this.getOptions("className"), f = "tap ." + e, g = f + " .btn-usual-ok", h = f + " .btn-usual-cancel", i = {};
        i[g] = b, i[h] = c, this.events = a.defaults(i, this.events || {}), this.delegateEvents(this.events)
    },setCallBack: function() {
        var a = this.getOptions(this.POPUP_DATA_KEY);
        this.options.okCallBackName = a.okCallBackName || null, this.options.url = a.url || null, this.options.cancelCallBackName = a.cancelCallBackName || null
    },setDisplayData: function(a, b) {
        var c = this.getOptions(this.POPUP_DATA_KEY);
        this.options.title = c.title, this.options.body = c.body, this.options.flagBtnOk = null == a ? 0 : 1, this.options.flagBtnCancel = null == b ? 0 : 1
    },getOptions: function(a) {
        return this.options[a]
    },destroy: function() {
        this.captchaView.destroy(), i.prototype.destroy.call(this)
    },locationMypage: function() {
        this.popRemove(), Game.view.content_close(), b.history.navigate("mypage", !0)
    },locationQuest: function() {
        this.popRemove(), Game.view.content_close(), b.history.navigate("quest", !0)
    },locationGuild: function() {
        this.popRemove(), Game.view.content_close(), b.history.navigate("guild", !0), window.location.reload()
    },locationCoopraid: function() {
        this.popRemove(), Game.view.content_close(), b.history.navigate("coopraid", !0)
    },navigateReload: function() {
        Game.view.content_close(), location.reload()
    },locationSpecifyUrl: function() {
        this.popRemove(), Game.view.content_close(), b.history.navigate(this.getOptions("url"), !0)
    },locationSpecifyUrlWithPopRemove: function() {
        this.popRemove(), Game.view.content_close(), b.history.navigate(this.getOptions("url"), !0)
    },locationParty: function() {
        this.popRemove(), Game.view.content_close(), b.history.navigate("party/index/0/npc/0", !0)
...
define('view/game-view', ["underscore", "backbone"], function(a, b) {
    var c = b.View.extend({el: "#canvas",stage: null,img_manage: null,completed: null,initialize: function() {
        this.queue = new createjs.LoadQueue(!0), this.queue.setMaxConnections(5), this.queue.addEventListener("error", this.handleError), this.queue.addEventListener("fileload", this.handleFileLoad), this.queue.addEventListener("complete", this.handleComplete.bind(this));
        var a = [], c = !1;
        this.img_manage = [], this.completed = new (b.Model.extend({defaults: {complete_flg: !1}}));
        for (var d = 0; d <= this.model.length - 1; d++)
            for (var e = 0; e <= this.model[d].get("manifest").length - 1; e++)
                this.is_image_id(this.model[d].get("manifest")[e].id) || (a = a.concat(this.model[d].get("manifest")[e]), c = !0);
        "undefined" != typeof this.options.pcWeaponId && this.options.pcWeaponId && (a = a.concat({id: "pcWeaponId",src: Game.imgUri + "/sp/cjs/" + this.options.pcWeaponId + ".png"})), c ? this.queue.loadManifest(a) : this.queue.dispatchEvent("complete")
    },render: function() {
        var a = document.getElementById("canvas");
        this.stage = new createjs.Stage(a), createjs.Ticker.setFPS(12), createjs.Ticker.addEventListener("tick", this.stage), stage = this.stage, this.options.hash && (location.href = "#" + this.options.hash), this.completed.set({complete_flg: !0}), this.queue.removeEventListener("error", this.handleError), this.queue.removeEventListener("fileload", this.handleFileLoad), this.queue.removeEventListener("complete", this.handleComplete.bind(this)), delete this.queue, this.queue = null
    },handleError: function(a) {
    },handleFileLoad: function(a) {
        ...
        var b = !1;
        return "undefined" != typeof images[a] ? b = !0 : -1 === $.inArray(a, this.img_manage) || "weapon" == a ? this.img_manage.push(a) : b = !0, b
    }});
    return c
});
...
define('util/jquery.events', ["jquery"], function(a) {
    var b = {animationend: "animationend webkitAnimationEnd",transitionend: "transitionend webkitTransitionEnd"}, c = function(a, c, d, e) {
        ...
        a.on(h, function i() {
            a.off(h, i), window.clearTimeout(f), g || (g = !0, d.call(a))
        })
    };
    return a.fn.extend({oneAnimationEnd: function(a, b) {
        return c(this, "animationend", a, b), this

define(["lib/raid/timeline", "model/sound"], function (a, b) {
    var c = {
        ...
        mChangeMotionAll: function (b, d, e, f) {
            ...
            for (var g = stage.gGameStatus[e.type].param, h = !0, i = "", j = "", k = 0; k <= d.length - 1; k++)if ("on" !== e.is_alive || 0 != g[k].alive) {
                h = !1;
                var l = "player" === e.type ? 1 == stage.gGameStatus.player.param[k].leader ? "job" : "npc" : "enemy";
                i = "", "player" === e.type && (j = e.current_hp ? e.current_hp : stage.gGameStatus.player.param[k].hp), i = !e.is_replace && e.motion == c.pDownTarget && "player" === e.type && j / stage.gGameStatus.player.param[k].hpmax <= c.pDownThreshold ? c.pDownLabel : e.motion, this.mIsSpecialMotion({
                    type: e.type,
                    pos: k,
                    motion: i
                }) && (i = stage.gGameStatus.player.param[k].condition.special_motion), "1" != stage.pJsnData.effect_mode && (i = c.mCjsLabelSelecter(l, i)), d[k].wait(e.wait).call(function (a, b, c) {
                    console.info(b[a][e.mc[a].cjs]);
        ...
        mResetMotion: function (a, b) {
            ...
            "player" === b.type && (g = b.current_hp ? b.current_hp : stage.gGameStatus.player.param[b.pos].hp), f = !b.is_replace && b.motion == c.pDownTarget && "player" === b.type && g / stage.gGameStatus.player.param[b.pos].hpmax <= c.pDownThreshold ? c.pDownLabel : b.motion, this.mIsSpecialMotion({
                type: b.type,
                pos: b.pos,
                motion: f
            }) && (f = stage.gGameStatus.player.param[b.pos].condition.special_motion), "1" != stage.pJsnData.effect_mode && (f = c.mCjsLabelSelecter(e, f)), a.call(function (a) {
        ...
        mChangeMotionInstantly: function (a) {
            ...
            "player" === a.type && (i = a.current_hp ? a.current_hp : stage.gGameStatus.player.param[a.pos].hp), h = !a.is_replace && a.motion == c.pDownTarget && "player" === a.type && i / stage.gGameStatus.player.param[a.pos].hpmax <= c.pDownThreshold ? c.pDownLabel : a.motion, this.mIsSpecialMotion({
                type: a.type,
                pos: a.pos,
                motion: h
            }) && (h = stage.gGameStatus.player.param[a.pos].condition.special_motion), "1" != stage.pJsnData.effect_mode && (h = c.mCjsLabelSelecter(g, h));
            var j = 0;

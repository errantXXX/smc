define(["underscore", "backbone", "typist", "view/quest/abstract-view"], function (a, b, c, d) {
    var e = null, f = d.extend({el: ".prt-message-area", render: function (a, b, c) {
        ...
        var f = {height: "auto", fontFamily: "inherit", fontSize: 0}, g = d.$(".txt-message").typist(f), h = a.split(/<br.*?>/gi), i = d._countMessageLength(h),
            j = function () {
        ...
        b && 0 != m ? ($(".btn-skip").css("opacity", "1"),
            $(".ico-cursor-talk").hide(), l()) : (this.$(".txt-message").html(a),
            j(),
            $(".btn-skip").css("opacity", "1"),
            c.length > 0 && k(),

define(["jquery", "underscore", "backbone", "model/raid/setup", "lib/raid/draw", "lib/raid/motion", "lib/raid/timeline", "lib/raid/effect", "lib/raid/display", "lib/raid/cutin", "model/cjs-loader", "model/manifest-loader", "lib/shellapp", "lib/sound", "model/sound", "model/raid/condition", "model/socket", "view/popup", "model/token-data", "view/content", "util/navigate", "model/data", "util/local-storage", "flexslider", "util/sprite-sheet-manager", "view/raid/ui", "view/raid/_play_pre_battle", "view/raid/_play_pre_battle_sfv", "util/language-message", "model/chat/semiraid"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, A, B, C, D) {
    var E, F, G = 5, H = 3, I = 1, J = 12, K = Math.round(1e3 / J * 100) / 100, L = 30, M = 99, N = "miss", O = "guard", P = "noeffect", Q = "7001", R = ["70670", "70950", "80000"], S = {1: 10, 2: 15, 3: 20}, T = {1: 30}, U = "bgm/100_sfvcollabo_congratulations_loop.mp3", V = [1055, 1056], W = 3, X = 1e4, Y = 3, Z = "se/arcarum_result_se_1.mp3", $ = "se/arcarum_supression_se_1b.mp3", _ = "se/arcarum_supression_se_2.mp3", aa = {712954: {className: "img-riddle-splash", filePath: "quest/riddle/assets/bg/bg_22.jpg"}}, ba = {712954: {getMessageId: "riddle_battle_1"}}, ca = {}, da = 300, ea = 20, fa = 10, ga = Game.imgUri + "/sp/assets/npc/raid_normal/3999999999.jpg", ha = function (a, c, d, e) {
        b.isFunction(d) && (e = d, d = !1), (!ca[a] || Number(ca[a]) < Number(c)) && (d || (ca[a] = c), e && e())
    }, ia = function (a, b, c) {
    ...
    var wa, xa = function (a) {
        ...
        {x: 180, y: 504},
        {x: 99, y: 395}
    ]}}, Ma = "xhrStart", Na = "xhrEnd", Oa = t.extend({el: a(".contents"), stage: null, baseFps: 12, currentFps: 12, attackCount: 20, use_ap: null, popScrollHeightDelta: 0, initialize: function (c) {
        this.content_bind(), this.trigger(Ma);
        var e = this, f = new d, g = c;
        this.assist_flg = !1, this.preemptiveDeferred = new a.Deferred, this.cutinDeferred = new a.Deferred, a("#opaque-mask").show(), f.preSave(!1, g, {url: f.urlRoot(c.action, c.mode, c.is_multi, c.is_semi), silent: !0, error: function () {
        }, success: function () {
        ...
        return setTimeout(b.partial(k.loadFiles, p, !0), 0), k.once("complete", function () {
            l.once("complete", function () {
                ...
                o.setupScenarios(h, c, d, e, m, n).done(function () {
                    q.resolve()
                }).fail(function () {
                    q.reject()
    ...
    }, setupScenarios: function (e, g, k, p, q, s) {
